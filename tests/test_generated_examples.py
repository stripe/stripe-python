...
class TestGeneratedExamples(object):
    ...
    def test_customers_sources_verify_post_service(
        self, http_client_mock: HTTPClientMock
    ) -> None:
        http_client_mock.stub_request(
            "post",
        ...
        client.customers.payment_sources.verify(
            "cus_xxxxxxxxxxxxx",
            "ba_xxxxxxxxxxxxx",
            {"amounts": [32, 45]},
        )
        http_client_mock.assert_requested(
            "post",
            path="/v1/customers/cus_xxxxxxxxxxxxx/sources/ba_xxxxxxxxxxxxx/verify",
            query_string="",
            api_base="https://api.stripe.com",
            post_data="amounts[0]=32&amounts[1]=45",
        )
