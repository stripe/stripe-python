...
if TYPE_CHECKING:
    ...
    from stripe._payment_link_create_params import PaymentLinkCreateParams
    from stripe._payment_link_list_line_items_params import (
        PaymentLinkListLineItemsParams,
    )
    from stripe._payment_link_list_params import PaymentLinkListParams
    from stripe._payment_link_modify_params import PaymentLinkModifyParams
    from stripe._payment_link_retrieve_params import PaymentLinkRetrieveParams
