...
class Invoice(
    ...
    class CreatePreviewParamsScheduleDetailsAmendment(TypedDict):
        ...
        discount_actions: NotRequired[
            "List[Invoice.CreatePreviewParamsScheduleDetailsAmendmentDiscountAction]"
        ]
        """
        Changes to the coupons being redeemed or discounts being applied during the amendment time span.
        """
        item_actions: NotRequired[
            "List[Invoice.CreatePreviewParamsScheduleDetailsAmendmentItemAction]"
        ]
        """
        Changes to the subscription items during the amendment time span.
        """
        metadata_actions: NotRequired[
            "List[Invoice.CreatePreviewParamsScheduleDetailsAmendmentMetadataAction]"
        ]
        """
    ...
    class CreatePreviewParamsScheduleDetailsAmendmentItemActionAdd(TypedDict):
        discounts: NotRequired[
            "List[Invoice.CreatePreviewParamsScheduleDetailsAmendmentItemActionAddDiscount]"
        ]
        """
    ...
    class UpcomingLinesParamsScheduleDetailsAmendment(TypedDict):
        ...
        """
        discount_actions: NotRequired[
            "List[Invoice.UpcomingLinesParamsScheduleDetailsAmendmentDiscountAction]"
        ]
        """
        Changes to the coupons being redeemed or discounts being applied during the amendment time span.
        """
        item_actions: NotRequired[
            "List[Invoice.UpcomingLinesParamsScheduleDetailsAmendmentItemAction]"
        ]
        """
        Changes to the subscription items during the amendment time span.
        """
    ...
    class UpcomingLinesParamsScheduleDetailsAmendmentItemActionSet(TypedDict):
        discounts: NotRequired[
            "List[Invoice.UpcomingLinesParamsScheduleDetailsAmendmentItemActionSetDiscount]"
        ]
        """
        If an item with the `price` already exists, passing this will override the `discounts` array on the subscription item that matches that price. Otherwise, the `items` array is cleared and a single new item is added with the supplied `discounts`.
        """
    ...
    class UpcomingLinesParamsScheduleDetailsPhase(TypedDict):
        add_invoice_items: NotRequired[
            "List[Invoice.UpcomingLinesParamsScheduleDetailsPhaseAddInvoiceItem]"
        ]
        """
        A list of prices and quantities that will generate invoice items appended to the next invoice for this phase. You may pass up to 20 items.
        """
    ...
    class UpcomingParamsScheduleDetailsAmendmentItemActionAdd(TypedDict):
        discounts: NotRequired[
            "List[Invoice.UpcomingParamsScheduleDetailsAmendmentItemActionAddDiscount]"
        ]
        """
        The discounts applied to the item. Subscription item discounts are applied before subscription discounts.
        """
