...
if TYPE_CHECKING:
    ...
    from stripe.checkout._session_create_params import SessionCreateParams
    from stripe.checkout._session_expire_params import SessionExpireParams
    from stripe.checkout._session_list_line_items_params import (
        SessionListLineItemsParams,
    )
    from stripe.checkout._session_list_params import SessionListParams
    from stripe.checkout._session_modify_params import SessionModifyParams
    from stripe.checkout._session_retrieve_params import SessionRetrieveParams
