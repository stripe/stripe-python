...
if TYPE_CHECKING:
    ...
    from stripe._customer_create_params import CustomerCreateParams
    from stripe._customer_create_source_params import (
        CustomerCreateSourceParams,
    )
    from stripe._customer_create_tax_id_params import CustomerCreateTaxIdParams
    from stripe._customer_delete_discount_params import (
        CustomerDeleteDiscountParams,
    )
    from stripe._customer_delete_params import CustomerDeleteParams
    from stripe._customer_delete_source_params import (
        CustomerDeleteSourceParams,
    )
    from stripe._customer_delete_tax_id_params import CustomerDeleteTaxIdParams
    ...
    from stripe._customer_list_params import CustomerListParams
    from stripe._customer_list_payment_methods_params import (
        CustomerListPaymentMethodsParams,
    )
    from stripe._customer_list_sources_params import CustomerListSourcesParams
    from stripe._customer_list_tax_ids_params import CustomerListTaxIdsParams
    ...
    from stripe._customer_modify_params import CustomerModifyParams
    ...
    from stripe._customer_retrieve_params import CustomerRetrieveParams
    ...
    from stripe._customer_search_params import CustomerSearchParams
