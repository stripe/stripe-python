...
class V2MoneyManagementFinancialAccountWalletExportPendingEventNotification(
    EventNotification,
):
    LOOKUP_TYPE = "v2.money_management.financial_account.wallet_export.pending"
    type: Literal[
...
class V2MoneyManagementFinancialAccountWalletExportPendingEvent(Event):
    LOOKUP_TYPE = "v2.money_management.financial_account.wallet_export.pending"
    type: Literal[
        "v2.money_management.financial_account.wallet_export.pending"
    ]
