...
class V1PromotionCodeUpdatedEventNotification(EventNotification):
    LOOKUP_TYPE = "v1.promotion_code.updated"
    type: Literal["v1.promotion_code.updated"]
    ...
    @override
    def fetch_event(self) -> "V1PromotionCodeUpdatedEvent":
        return cast(
    ...
    @override
    async def fetch_event_async(self) -> "V1PromotionCodeUpdatedEvent":
        return cast(
            "V1PromotionCodeUpdatedEvent",
...
class V1PromotionCodeUpdatedEvent(Event):
    LOOKUP_TYPE = "v1.promotion_code.updated"
    type: Literal["v1.promotion_code.updated"]
