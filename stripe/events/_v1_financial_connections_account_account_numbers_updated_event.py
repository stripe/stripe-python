...
class V1FinancialConnectionsAccountAccountNumbersUpdatedEventNotification(
    EventNotification,
):
    LOOKUP_TYPE = "v1.financial_connections.account.account_numbers_updated"
    type: Literal["v1.financial_connections.account.account_numbers_updated"]
...
class V1FinancialConnectionsAccountAccountNumbersUpdatedEvent(Event):
    LOOKUP_TYPE = "v1.financial_connections.account.account_numbers_updated"
    type: Literal["v1.financial_connections.account.account_numbers_updated"]
