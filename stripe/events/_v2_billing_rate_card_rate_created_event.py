...
class V2BillingRateCardRateCreatedEventNotification(EventNotification):
    ...
    @override
    def fetch_event(self) -> "V2BillingRateCardRateCreatedEvent":
        return cast(
    ...
    @override
    async def fetch_event_async(self) -> "V2BillingRateCardRateCreatedEvent":
        return cast(
            "V2BillingRateCardRateCreatedEvent",
            await super().fetch_event_async(),
        )

    async def fetch_related_object_async(self) -> "RateCardRate":
