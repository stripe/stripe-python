...
class V2PaymentsSettlementAllocationIntentSplitSettledEventNotification(
    EventNotification,
):
    LOOKUP_TYPE = "v2.payments.settlement_allocation_intent_split.settled"
    type: Literal["v2.payments.settlement_allocation_intent_split.settled"]
...
class V2PaymentsSettlementAllocationIntentSplitSettledEvent(Event):
    LOOKUP_TYPE = "v2.payments.settlement_allocation_intent_split.settled"
    type: Literal["v2.payments.settlement_allocation_intent_split.settled"]

    class V2PaymentsSettlementAllocationIntentSplitSettledEventData(
        StripeObject,
    ):
    ...
    data: V2PaymentsSettlementAllocationIntentSplitSettledEventData
    """
    ...
    def _construct_from(
        ...
        *,
        ...
        if hasattr(evt, "data"):
            evt.data = V2PaymentsSettlementAllocationIntentSplitSettledEvent.V2PaymentsSettlementAllocationIntentSplitSettledEventData._construct_from(
                values=evt.data,
                last_response=last_response,
                requestor=requestor,
                api_mode=api_mode,
