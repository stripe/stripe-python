...
class V2CoreAccountIncludingConfigurationMoneyManagerUpdatedEventNotification(
    ...
    LOOKUP_TYPE = "v2.core.account[configuration.money_manager].updated"
    type: Literal["v2.core.account[configuration.money_manager].updated"]
...
class V2CoreAccountIncludingConfigurationMoneyManagerUpdatedEvent(Event):
    LOOKUP_TYPE = "v2.core.account[configuration.money_manager].updated"
    type: Literal["v2.core.account[configuration.money_manager].updated"]
