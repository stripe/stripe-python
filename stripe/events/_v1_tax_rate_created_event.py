...
class V1TaxRateCreatedEventNotification(EventNotification):
    ...
    @override
    def fetch_event(self) -> "V1TaxRateCreatedEvent":
        return cast(
    ...
    @override
    async def fetch_event_async(self) -> "V1TaxRateCreatedEvent":
        return cast(
            "V1TaxRateCreatedEvent",
