...
class V1TestHelpersTestClockCreatedEventNotification(EventNotification):
    ...
    @override
    def fetch_event(self) -> "V1TestHelpersTestClockCreatedEvent":
        return cast(
    ...
    @override
    async def fetch_event_async(self) -> "V1TestHelpersTestClockCreatedEvent":
        return cast(
            "V1TestHelpersTestClockCreatedEvent",
