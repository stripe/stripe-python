...
class V2BillingContractCollectionUnpaidEventNotification(EventNotification):
    LOOKUP_TYPE = "v2.billing.contract.collection_unpaid"
    type: Literal["v2.billing.contract.collection_unpaid"]
    ...
    @override
    def fetch_event(self) -> "V2BillingContractCollectionUnpaidEvent":
        return cast(
...
class V2BillingContractCollectionUnpaidEvent(Event):
    LOOKUP_TYPE = "v2.billing.contract.collection_unpaid"
    type: Literal["v2.billing.contract.collection_unpaid"]
