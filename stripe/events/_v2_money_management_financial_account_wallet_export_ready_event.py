...
class V2MoneyManagementFinancialAccountWalletExportReadyEventNotification(
    EventNotification,
):
    LOOKUP_TYPE = "v2.money_management.financial_account.wallet_export.ready"
    type: Literal["v2.money_management.financial_account.wallet_export.ready"]
...
class V2MoneyManagementFinancialAccountWalletExportReadyEvent(Event):
    LOOKUP_TYPE = "v2.money_management.financial_account.wallet_export.ready"
    type: Literal["v2.money_management.financial_account.wallet_export.ready"]
