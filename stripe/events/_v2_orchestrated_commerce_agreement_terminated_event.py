...
class V2OrchestratedCommerceAgreementTerminatedEventNotification(
    EventNotification,
):
    LOOKUP_TYPE = "v2.orchestrated_commerce.agreement.terminated"
    ...
    @override
    def fetch_event(self) -> "V2OrchestratedCommerceAgreementTerminatedEvent":
        return cast(
...
class V2OrchestratedCommerceAgreementTerminatedEvent(Event):
    LOOKUP_TYPE = "v2.orchestrated_commerce.agreement.terminated"
    type: Literal["v2.orchestrated_commerce.agreement.terminated"]

    class V2OrchestratedCommerceAgreementTerminatedEventData(StripeObject):
        ...
        """
        terminated_by: Literal["orchestrator", "seller"]
        """
    ...
    data: V2OrchestratedCommerceAgreementTerminatedEventData
    """
    Data for the v2.orchestrated_commerce.agreement.terminated event
    """
    ...
    def _construct_from(
        ...
        *,
        ...
        if hasattr(evt, "data"):
            evt.data = V2OrchestratedCommerceAgreementTerminatedEvent.V2OrchestratedCommerceAgreementTerminatedEventData._construct_from(
                values=evt.data,
                last_response=last_response,
                requestor=requestor,
                api_mode=api_mode,
