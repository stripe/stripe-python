...
class V2PaymentsOffSessionPaymentPausedEventNotification(EventNotification):
    LOOKUP_TYPE = "v2.payments.off_session_payment.paused"
    type: Literal["v2.payments.off_session_payment.paused"]
    ...
    @override
    def fetch_event(self) -> "V2PaymentsOffSessionPaymentPausedEvent":
        return cast(
...
class V2PaymentsOffSessionPaymentPausedEvent(Event):
    LOOKUP_TYPE = "v2.payments.off_session_payment.paused"
    type: Literal["v2.payments.off_session_payment.paused"]
