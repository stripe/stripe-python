...
class V2PaymentsOffSessionPaymentSucceededEventNotification(EventNotification):
    LOOKUP_TYPE = "v2.payments.off_session_payment.succeeded"
    type: Literal["v2.payments.off_session_payment.succeeded"]
    ...
    @override
    def fetch_event(self) -> "V2PaymentsOffSessionPaymentSucceededEvent":
        return cast(
...
class V2PaymentsOffSessionPaymentSucceededEvent(Event):
    LOOKUP_TYPE = "v2.payments.off_session_payment.succeeded"
    type: Literal["v2.payments.off_session_payment.succeeded"]
