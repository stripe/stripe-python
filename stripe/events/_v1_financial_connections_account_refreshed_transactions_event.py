...
class V1FinancialConnectionsAccountRefreshedTransactionsEventNotification(
    EventNotification,
):
    LOOKUP_TYPE = "v1.financial_connections.account.refreshed_transactions"
    type: Literal["v1.financial_connections.account.refreshed_transactions"]
...
class V1FinancialConnectionsAccountRefreshedTransactionsEvent(Event):
    LOOKUP_TYPE = "v1.financial_connections.account.refreshed_transactions"
    type: Literal["v1.financial_connections.account.refreshed_transactions"]
