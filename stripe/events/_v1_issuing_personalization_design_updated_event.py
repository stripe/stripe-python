...
class V1IssuingPersonalizationDesignUpdatedEventNotification(
    EventNotification
):
    LOOKUP_TYPE = "v1.issuing_personalization_design.updated"
    type: Literal["v1.issuing_personalization_design.updated"]
    ...
    @override
    def fetch_event(self) -> "V1IssuingPersonalizationDesignUpdatedEvent":
        return cast(
...
class V1IssuingPersonalizationDesignUpdatedEvent(Event):
    LOOKUP_TYPE = "v1.issuing_personalization_design.updated"
    type: Literal["v1.issuing_personalization_design.updated"]
