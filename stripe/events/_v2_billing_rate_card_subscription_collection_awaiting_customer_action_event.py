...
class V2BillingRateCardSubscriptionCollectionAwaitingCustomerActionEventNotification(
    EventNotification,
):
    LOOKUP_TYPE = (
...
class V2BillingRateCardSubscriptionCollectionAwaitingCustomerActionEvent(
    Event
):
    LOOKUP_TYPE = (
        "v2.billing.rate_card_subscription.collection_awaiting_customer_action"
