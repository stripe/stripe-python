...
class V2OrchestratedCommerceAgreementCreatedEventNotification(
    EventNotification,
):
    LOOKUP_TYPE = "v2.orchestrated_commerce.agreement.created"
    type: Literal["v2.orchestrated_commerce.agreement.created"]
    ...
    @override
    def fetch_event(self) -> "V2OrchestratedCommerceAgreementCreatedEvent":
        return cast(
...
class V2OrchestratedCommerceAgreementCreatedEvent(Event):
    LOOKUP_TYPE = "v2.orchestrated_commerce.agreement.created"
    type: Literal["v2.orchestrated_commerce.agreement.created"]

    class V2OrchestratedCommerceAgreementCreatedEventData(StripeObject):
    ...
    data: V2OrchestratedCommerceAgreementCreatedEventData
    """
    ...
    def _construct_from(
        ...
        *,
        ...
        if hasattr(evt, "data"):
            evt.data = V2OrchestratedCommerceAgreementCreatedEvent.V2OrchestratedCommerceAgreementCreatedEventData._construct_from(
                values=evt.data,
                last_response=last_response,
                requestor=requestor,
                api_mode=api_mode,
