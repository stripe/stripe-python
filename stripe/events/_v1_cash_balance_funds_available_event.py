...
class V1CashBalanceFundsAvailableEventNotification(EventNotification):
    ...
    def fetch_related_object(self) -> "CashBalance":
    ...
    @override
    async def fetch_event_async(self) -> "V1CashBalanceFundsAvailableEvent":
        return cast(
            "V1CashBalanceFundsAvailableEvent",
            await super().fetch_event_async(),
        )

    async def fetch_related_object_async(self) -> "CashBalance":
...
class V1CashBalanceFundsAvailableEvent(Event):
    LOOKUP_TYPE = "v1.cash_balance.funds_available"
    type: Literal["v1.cash_balance.funds_available"]
