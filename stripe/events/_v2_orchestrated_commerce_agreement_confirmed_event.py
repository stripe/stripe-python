...
class V2OrchestratedCommerceAgreementConfirmedEventNotification(
    EventNotification,
):
    LOOKUP_TYPE = "v2.orchestrated_commerce.agreement.confirmed"
    type: Literal["v2.orchestrated_commerce.agreement.confirmed"]
    ...
    @override
    def fetch_event(self) -> "V2OrchestratedCommerceAgreementConfirmedEvent":
        return cast(
...
class V2OrchestratedCommerceAgreementConfirmedEvent(Event):
    LOOKUP_TYPE = "v2.orchestrated_commerce.agreement.confirmed"
    type: Literal["v2.orchestrated_commerce.agreement.confirmed"]

    class V2OrchestratedCommerceAgreementConfirmedEventData(StripeObject):
    ...
    data: V2OrchestratedCommerceAgreementConfirmedEventData
    """
    Data for the v2.orchestrated_commerce.agreement.confirmed event
    """
    ...
    def _construct_from(
        ...
        *,
        ...
        if hasattr(evt, "data"):
            evt.data = V2OrchestratedCommerceAgreementConfirmedEvent.V2OrchestratedCommerceAgreementConfirmedEventData._construct_from(
                values=evt.data,
                last_response=last_response,
                requestor=requestor,
                api_mode=api_mode,
