...
class V2BillingContractCollectionPastDueEventNotification(EventNotification):
    LOOKUP_TYPE = "v2.billing.contract.collection_past_due"
    type: Literal["v2.billing.contract.collection_past_due"]
    ...
    @override
    def fetch_event(self) -> "V2BillingContractCollectionPastDueEvent":
        return cast(
...
class V2BillingContractCollectionPastDueEvent(Event):
    LOOKUP_TYPE = "v2.billing.contract.collection_past_due"
    type: Literal["v2.billing.contract.collection_past_due"]
