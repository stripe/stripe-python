...
class V2MoneyManagementReceivedDebitMandatePendingCancellationEventNotification(
    EventNotification,
):
    LOOKUP_TYPE = (
...
class V2MoneyManagementReceivedDebitMandatePendingCancellationEvent(Event):
    LOOKUP_TYPE = (
        "v2.money_management.received_debit_mandate.pending_cancellation"
    )
    type: Literal[
