...
class V2MoneyManagementReceivedDebitScheduledEventNotification(
    EventNotification,
):
    LOOKUP_TYPE = "v2.money_management.received_debit.scheduled"
    type: Literal["v2.money_management.received_debit.scheduled"]
    ...
    @override
    def fetch_event(self) -> "V2MoneyManagementReceivedDebitScheduledEvent":
        return cast(
...
class V2MoneyManagementReceivedDebitScheduledEvent(Event):
    LOOKUP_TYPE = "v2.money_management.received_debit.scheduled"
    type: Literal["v2.money_management.received_debit.scheduled"]
