...
class V2BillingContractCanceledEventNotification(EventNotification):
    LOOKUP_TYPE = "v2.billing.contract.canceled"
    type: Literal["v2.billing.contract.canceled"]
    ...
    @override
    def fetch_event(self) -> "V2BillingContractCanceledEvent":
        return cast(
    ...
    @override
    async def fetch_event_async(self) -> "V2BillingContractCanceledEvent":
        return cast(
            "V2BillingContractCanceledEvent",
...
class V2BillingContractCanceledEvent(Event):
    LOOKUP_TYPE = "v2.billing.contract.canceled"
    type: Literal["v2.billing.contract.canceled"]
