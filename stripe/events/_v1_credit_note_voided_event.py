...
class V1CreditNoteVoidedEventNotification(EventNotification):
    ...
    @override
    def fetch_event(self) -> "V1CreditNoteVoidedEvent":
        return cast(
    ...
    @override
    async def fetch_event_async(self) -> "V1CreditNoteVoidedEvent":
        return cast(
            "V1CreditNoteVoidedEvent",
