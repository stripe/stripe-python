...
class V1IssuingPersonalizationDesignDeactivatedEventNotification(
    EventNotification,
):
    LOOKUP_TYPE = "v1.issuing_personalization_design.deactivated"
    type: Literal["v1.issuing_personalization_design.deactivated"]
    ...
    @override
    def fetch_event(self) -> "V1IssuingPersonalizationDesignDeactivatedEvent":
        return cast(
...
class V1IssuingPersonalizationDesignDeactivatedEvent(Event):
    LOOKUP_TYPE = "v1.issuing_personalization_design.deactivated"
    type: Literal["v1.issuing_personalization_design.deactivated"]
