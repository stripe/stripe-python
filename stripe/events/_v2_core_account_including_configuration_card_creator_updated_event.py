...
class V2CoreAccountIncludingConfigurationCardCreatorUpdatedEventNotification(
    EventNotification,
):
    LOOKUP_TYPE = "v2.core.account[configuration.card_creator].updated"
    type: Literal["v2.core.account[configuration.card_creator].updated"]
...
class V2CoreAccountIncludingConfigurationCardCreatorUpdatedEvent(Event):
    LOOKUP_TYPE = "v2.core.account[configuration.card_creator].updated"
    type: Literal["v2.core.account[configuration.card_creator].updated"]
