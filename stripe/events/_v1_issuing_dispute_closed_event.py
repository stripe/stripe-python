...
class V1IssuingDisputeClosedEventNotification(EventNotification):
    LOOKUP_TYPE = "v1.issuing_dispute.closed"
    type: Literal["v1.issuing_dispute.closed"]
    ...
    @override
    def fetch_event(self) -> "V1IssuingDisputeClosedEvent":
        return cast(
    ...
    @override
    async def fetch_event_async(self) -> "V1IssuingDisputeClosedEvent":
        return cast(
            "V1IssuingDisputeClosedEvent",
...
class V1IssuingDisputeClosedEvent(Event):
    LOOKUP_TYPE = "v1.issuing_dispute.closed"
    type: Literal["v1.issuing_dispute.closed"]
