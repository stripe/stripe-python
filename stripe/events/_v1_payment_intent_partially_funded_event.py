...
class V1PaymentIntentPartiallyFundedEventNotification(EventNotification):
    ...
    @override
    def fetch_event(self) -> "V1PaymentIntentPartiallyFundedEvent":
        return cast(
    ...
    @override
    async def fetch_event_async(self) -> "V1PaymentIntentPartiallyFundedEvent":
        return cast(
            "V1PaymentIntentPartiallyFundedEvent",
