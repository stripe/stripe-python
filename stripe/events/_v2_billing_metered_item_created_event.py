...
class V2BillingMeteredItemCreatedEventNotification(EventNotification):
    ...
    @override
    def fetch_event(self) -> "V2BillingMeteredItemCreatedEvent":
        return cast(
    ...
    @override
    async def fetch_event_async(self) -> "V2BillingMeteredItemCreatedEvent":
        return cast(
            "V2BillingMeteredItemCreatedEvent",
