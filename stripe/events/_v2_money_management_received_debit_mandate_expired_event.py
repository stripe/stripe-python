...
class V2MoneyManagementReceivedDebitMandateExpiredEventNotification(
    EventNotification,
):
    LOOKUP_TYPE = "v2.money_management.received_debit_mandate.expired"
    type: Literal["v2.money_management.received_debit_mandate.expired"]
...
class V2MoneyManagementReceivedDebitMandateExpiredEvent(Event):
    LOOKUP_TYPE = "v2.money_management.received_debit_mandate.expired"
    type: Literal["v2.money_management.received_debit_mandate.expired"]
