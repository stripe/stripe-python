...
class V1ProductCreatedEventNotification(EventNotification):
    LOOKUP_TYPE = "v1.product.created"
    type: Literal["v1.product.created"]
    ...
    @override
    def fetch_event(self) -> "V1ProductCreatedEvent":
        return cast(
    ...
    @override
    async def fetch_event_async(self) -> "V1ProductCreatedEvent":
        return cast(
            "V1ProductCreatedEvent",
...
class V1ProductCreatedEvent(Event):
    LOOKUP_TYPE = "v1.product.created"
    type: Literal["v1.product.created"]
