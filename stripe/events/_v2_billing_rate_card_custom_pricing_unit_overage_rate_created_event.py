...
class V2BillingRateCardCustomPricingUnitOverageRateCreatedEventNotification(
    EventNotification,
):
    LOOKUP_TYPE = (
    ...
    def fetch_related_object(self) -> "RateCardCustomPricingUnitOverageRate":
...
class V2BillingRateCardCustomPricingUnitOverageRateCreatedEvent(Event):
    LOOKUP_TYPE = (
        "v2.billing.rate_card_custom_pricing_unit_overage_rate.created"
    )
    type: Literal[
    ...
    class V2BillingRateCardCustomPricingUnitOverageRateCreatedEventData(
        StripeObject,
    ):
        created: str
        """
    ...
    data: V2BillingRateCardCustomPricingUnitOverageRateCreatedEventData
    """
    ...
    def _construct_from(
        ...
        *,
        ...
        if hasattr(evt, "data"):
            evt.data = V2BillingRateCardCustomPricingUnitOverageRateCreatedEvent.V2BillingRateCardCustomPricingUnitOverageRateCreatedEventData._construct_from(
                values=evt.data,
                last_response=last_response,
                requestor=requestor,
                api_mode=api_mode,
