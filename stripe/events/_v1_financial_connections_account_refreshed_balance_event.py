...
class V1FinancialConnectionsAccountRefreshedBalanceEventNotification(
    EventNotification,
):
    LOOKUP_TYPE = "v1.financial_connections.account.refreshed_balance"
    type: Literal["v1.financial_connections.account.refreshed_balance"]
...
class V1FinancialConnectionsAccountRefreshedBalanceEvent(Event):
    LOOKUP_TYPE = "v1.financial_connections.account.refreshed_balance"
    type: Literal["v1.financial_connections.account.refreshed_balance"]
