...
class V1PaymentIntentCreatedEventNotification(EventNotification):
    ...
    @override
    def fetch_event(self) -> "V1PaymentIntentCreatedEvent":
        return cast(
    ...
    @override
    async def fetch_event_async(self) -> "V1PaymentIntentCreatedEvent":
        return cast(
            "V1PaymentIntentCreatedEvent",
