...
class V2ExtendWorkflowRunStartedEventNotification(EventNotification):
    LOOKUP_TYPE = "v2.extend.workflow_run.started"
    type: Literal["v2.extend.workflow_run.started"]
    ...
    @override
    def fetch_event(self) -> "V2ExtendWorkflowRunStartedEvent":
        return cast(
    ...
    @override
    async def fetch_event_async(self) -> "V2ExtendWorkflowRunStartedEvent":
        return cast(
            "V2ExtendWorkflowRunStartedEvent",
...
class V2ExtendWorkflowRunStartedEvent(Event):
    LOOKUP_TYPE = "v2.extend.workflow_run.started"
    type: Literal["v2.extend.workflow_run.started"]
