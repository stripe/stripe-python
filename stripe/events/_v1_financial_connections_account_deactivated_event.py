...
class V1FinancialConnectionsAccountDeactivatedEventNotification(
    EventNotification,
):
    LOOKUP_TYPE = "v1.financial_connections.account.deactivated"
    type: Literal["v1.financial_connections.account.deactivated"]
    ...
    @override
    def fetch_event(self) -> "V1FinancialConnectionsAccountDeactivatedEvent":
        return cast(
...
class V1FinancialConnectionsAccountDeactivatedEvent(Event):
    LOOKUP_TYPE = "v1.financial_connections.account.deactivated"
    type: Literal["v1.financial_connections.account.deactivated"]
