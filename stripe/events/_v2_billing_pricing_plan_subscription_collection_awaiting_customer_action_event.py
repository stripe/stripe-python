...
class V2BillingPricingPlanSubscriptionCollectionAwaitingCustomerActionEventNotification(
    ...
    LOOKUP_TYPE = "v2.billing.pricing_plan_subscription.collection_awaiting_customer_action"
    type: Literal[
...
class V2BillingPricingPlanSubscriptionCollectionAwaitingCustomerActionEvent(
    Event,
):
    LOOKUP_TYPE = "v2.billing.pricing_plan_subscription.collection_awaiting_customer_action"
    type: Literal[
