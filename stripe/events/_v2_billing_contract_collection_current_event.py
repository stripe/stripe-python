...
class V2BillingContractCollectionCurrentEventNotification(EventNotification):
    LOOKUP_TYPE = "v2.billing.contract.collection_current"
    type: Literal["v2.billing.contract.collection_current"]
    ...
    @override
    def fetch_event(self) -> "V2BillingContractCollectionCurrentEvent":
        return cast(
...
class V2BillingContractCollectionCurrentEvent(Event):
    LOOKUP_TYPE = "v2.billing.contract.collection_current"
    type: Literal["v2.billing.contract.collection_current"]
