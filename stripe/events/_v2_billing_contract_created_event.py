...
class V2BillingContractCreatedEventNotification(EventNotification):
    LOOKUP_TYPE = "v2.billing.contract.created"
    type: Literal["v2.billing.contract.created"]
    ...
    @override
    def fetch_event(self) -> "V2BillingContractCreatedEvent":
        return cast(
    ...
    @override
    async def fetch_event_async(self) -> "V2BillingContractCreatedEvent":
        return cast(
            "V2BillingContractCreatedEvent",
...
class V2BillingContractCreatedEvent(Event):
    LOOKUP_TYPE = "v2.billing.contract.created"
    type: Literal["v2.billing.contract.created"]
