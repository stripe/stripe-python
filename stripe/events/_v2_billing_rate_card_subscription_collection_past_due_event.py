...
class V2BillingRateCardSubscriptionCollectionPastDueEventNotification(
    EventNotification,
):
    LOOKUP_TYPE = "v2.billing.rate_card_subscription.collection_past_due"
    type: Literal["v2.billing.rate_card_subscription.collection_past_due"]
...
class V2BillingRateCardSubscriptionCollectionPastDueEvent(Event):
    LOOKUP_TYPE = "v2.billing.rate_card_subscription.collection_past_due"
    type: Literal["v2.billing.rate_card_subscription.collection_past_due"]
