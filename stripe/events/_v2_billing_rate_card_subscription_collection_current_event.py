...
class V2BillingRateCardSubscriptionCollectionCurrentEventNotification(
    EventNotification,
):
    LOOKUP_TYPE = "v2.billing.rate_card_subscription.collection_current"
    type: Literal["v2.billing.rate_card_subscription.collection_current"]
...
class V2BillingRateCardSubscriptionCollectionCurrentEvent(Event):
    LOOKUP_TYPE = "v2.billing.rate_card_subscription.collection_current"
    type: Literal["v2.billing.rate_card_subscription.collection_current"]
