...
class V1TransferUpdatedEventNotification(EventNotification):
    ...
    @override
    def fetch_event(self) -> "V1TransferUpdatedEvent":
        return cast(
    ...
    @override
    async def fetch_event_async(self) -> "V1TransferUpdatedEvent":
        return cast(
            "V1TransferUpdatedEvent",
