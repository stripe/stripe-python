...
class V1FinancialConnectionsAccountUpcomingDeactivationEventNotification(
    EventNotification,
):
    LOOKUP_TYPE = "v1.financial_connections.account.upcoming_deactivation"
    type: Literal["v1.financial_connections.account.upcoming_deactivation"]
...
class V1FinancialConnectionsAccountUpcomingDeactivationEvent(Event):
    LOOKUP_TYPE = "v1.financial_connections.account.upcoming_deactivation"
    type: Literal["v1.financial_connections.account.upcoming_deactivation"]
