...
class V1AccountUpdatedEventNotification(EventNotification):
    LOOKUP_TYPE = "v1.account.updated"
    ...
    @override
    def fetch_event(self) -> "V1AccountUpdatedEvent":
        return cast(
    ...
    @override
    async def fetch_event_async(self) -> "V1AccountUpdatedEvent":
        return cast(
            "V1AccountUpdatedEvent",
...
class V1AccountUpdatedEvent(Event):
    LOOKUP_TYPE = "v1.account.updated"
    type: Literal["v1.account.updated"]
