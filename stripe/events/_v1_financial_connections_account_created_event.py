...
class V1FinancialConnectionsAccountCreatedEventNotification(EventNotification):
    LOOKUP_TYPE = "v1.financial_connections.account.created"
    type: Literal["v1.financial_connections.account.created"]
    ...
    @override
    def fetch_event(self) -> "V1FinancialConnectionsAccountCreatedEvent":
        return cast(
...
class V1FinancialConnectionsAccountCreatedEvent(Event):
    LOOKUP_TYPE = "v1.financial_connections.account.created"
    type: Literal["v1.financial_connections.account.created"]
