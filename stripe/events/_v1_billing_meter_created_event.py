...
class V1BillingMeterCreatedEventNotification(EventNotification):
    LOOKUP_TYPE = "v1.billing.meter.created"
    type: Literal["v1.billing.meter.created"]
    ...
    @override
    def fetch_event(self) -> "V1BillingMeterCreatedEvent":
        return cast(
    ...
    @override
    async def fetch_event_async(self) -> "V1BillingMeterCreatedEvent":
        return cast(
            "V1BillingMeterCreatedEvent",
...
class V1BillingMeterCreatedEvent(Event):
    LOOKUP_TYPE = "v1.billing.meter.created"
    type: Literal["v1.billing.meter.created"]
