...
class V2PaymentsOffSessionPaymentResumedEventNotification(EventNotification):
    LOOKUP_TYPE = "v2.payments.off_session_payment.resumed"
    type: Literal["v2.payments.off_session_payment.resumed"]
    ...
    @override
    def fetch_event(self) -> "V2PaymentsOffSessionPaymentResumedEvent":
        return cast(
...
class V2PaymentsOffSessionPaymentResumedEvent(Event):
    LOOKUP_TYPE = "v2.payments.off_session_payment.resumed"
    type: Literal["v2.payments.off_session_payment.resumed"]
