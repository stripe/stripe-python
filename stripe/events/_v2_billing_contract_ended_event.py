...
class V2BillingContractEndedEventNotification(EventNotification):
    LOOKUP_TYPE = "v2.billing.contract.ended"
    ...
    @override
    def fetch_event(self) -> "V2BillingContractEndedEvent":
        return cast(
    ...
    @override
    async def fetch_event_async(self) -> "V2BillingContractEndedEvent":
        return cast(
            "V2BillingContractEndedEvent",
...
class V2BillingContractEndedEvent(Event):
    LOOKUP_TYPE = "v2.billing.contract.ended"
    type: Literal["v2.billing.contract.ended"]
