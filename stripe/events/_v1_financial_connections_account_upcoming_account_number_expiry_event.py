...
class V1FinancialConnectionsAccountUpcomingAccountNumberExpiryEventNotification(
    EventNotification,
):
    LOOKUP_TYPE = (
...
class V1FinancialConnectionsAccountUpcomingAccountNumberExpiryEvent(Event):
    LOOKUP_TYPE = (
        "v1.financial_connections.account.upcoming_account_number_expiry"
    )
    type: Literal[
