...
class V1BillingMeterUpdatedEventNotification(EventNotification):
    LOOKUP_TYPE = "v1.billing.meter.updated"
    type: Literal["v1.billing.meter.updated"]
    ...
    @override
    def fetch_event(self) -> "V1BillingMeterUpdatedEvent":
        return cast(
    ...
    @override
    async def fetch_event_async(self) -> "V1BillingMeterUpdatedEvent":
        return cast(
            "V1BillingMeterUpdatedEvent",
...
class V1BillingMeterUpdatedEvent(Event):
    LOOKUP_TYPE = "v1.billing.meter.updated"
    type: Literal["v1.billing.meter.updated"]
