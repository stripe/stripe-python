...
class V2BillingContractUpdatedEventNotification(EventNotification):
    LOOKUP_TYPE = "v2.billing.contract.updated"
    type: Literal["v2.billing.contract.updated"]
    ...
    @override
    def fetch_event(self) -> "V2BillingContractUpdatedEvent":
        return cast(
    ...
    @override
    async def fetch_event_async(self) -> "V2BillingContractUpdatedEvent":
        return cast(
            "V2BillingContractUpdatedEvent",
...
class V2BillingContractUpdatedEvent(Event):
    LOOKUP_TYPE = "v2.billing.contract.updated"
    type: Literal["v2.billing.contract.updated"]
