...
class V2BillingRateCardSubscriptionServicingPausedEventNotification(
    EventNotification,
):
    LOOKUP_TYPE = "v2.billing.rate_card_subscription.servicing_paused"
    type: Literal["v2.billing.rate_card_subscription.servicing_paused"]
...
class V2BillingRateCardSubscriptionServicingPausedEvent(Event):
    LOOKUP_TYPE = "v2.billing.rate_card_subscription.servicing_paused"
    type: Literal["v2.billing.rate_card_subscription.servicing_paused"]
