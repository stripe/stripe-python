...
class V2MoneyManagementOutboundTransferUnderReviewEventNotification(
    EventNotification,
):
    LOOKUP_TYPE = "v2.money_management.outbound_transfer.under_review"
    type: Literal["v2.money_management.outbound_transfer.under_review"]
...
class V2MoneyManagementOutboundTransferUnderReviewEvent(Event):
    LOOKUP_TYPE = "v2.money_management.outbound_transfer.under_review"
    type: Literal["v2.money_management.outbound_transfer.under_review"]
