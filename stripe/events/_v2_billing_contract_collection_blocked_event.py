...
class V2BillingContractCollectionBlockedEventNotification(EventNotification):
    LOOKUP_TYPE = "v2.billing.contract.collection_blocked"
    type: Literal["v2.billing.contract.collection_blocked"]
    ...
    @override
    def fetch_event(self) -> "V2BillingContractCollectionBlockedEvent":
        return cast(
...
class V2BillingContractCollectionBlockedEvent(Event):
    LOOKUP_TYPE = "v2.billing.contract.collection_blocked"
    type: Literal["v2.billing.contract.collection_blocked"]
