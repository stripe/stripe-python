...
class V2BillingRateCardSubscriptionCanceledEventNotification(
    EventNotification
):
    LOOKUP_TYPE = "v2.billing.rate_card_subscription.canceled"
    type: Literal["v2.billing.rate_card_subscription.canceled"]
    ...
    @override
    def fetch_event(self) -> "V2BillingRateCardSubscriptionCanceledEvent":
        return cast(
...
class V2BillingRateCardSubscriptionCanceledEvent(Event):
    LOOKUP_TYPE = "v2.billing.rate_card_subscription.canceled"
    type: Literal["v2.billing.rate_card_subscription.canceled"]
