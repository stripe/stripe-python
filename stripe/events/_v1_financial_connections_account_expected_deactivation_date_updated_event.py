...
class V1FinancialConnectionsAccountExpectedDeactivationDateUpdatedEventNotification(
    EventNotification,
):
    LOOKUP_TYPE = (
...
class V1FinancialConnectionsAccountExpectedDeactivationDateUpdatedEvent(Event):
    LOOKUP_TYPE = (
        "v1.financial_connections.account.expected_deactivation_date_updated"
    )
    type: Literal[
