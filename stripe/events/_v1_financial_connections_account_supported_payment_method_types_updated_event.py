...
class V1FinancialConnectionsAccountSupportedPaymentMethodTypesUpdatedEventNotification(
    EventNotification,
):
    LOOKUP_TYPE = "v1.financial_connections.account.supported_payment_method_types_updated"
    type: Literal[
...
class V1FinancialConnectionsAccountSupportedPaymentMethodTypesUpdatedEvent(
    Event,
):
    LOOKUP_TYPE = "v1.financial_connections.account.supported_payment_method_types_updated"
    type: Literal[
