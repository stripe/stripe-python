...
class V2PaymentsOffSessionPaymentAttemptStartedEventNotification(
    EventNotification,
):
    LOOKUP_TYPE = "v2.payments.off_session_payment.attempt_started"
    type: Literal["v2.payments.off_session_payment.attempt_started"]
    ...
    @override
    def fetch_event(self) -> "V2PaymentsOffSessionPaymentAttemptStartedEvent":
        return cast(
...
class V2PaymentsOffSessionPaymentAttemptStartedEvent(Event):
    LOOKUP_TYPE = "v2.payments.off_session_payment.attempt_started"
    type: Literal["v2.payments.off_session_payment.attempt_started"]
