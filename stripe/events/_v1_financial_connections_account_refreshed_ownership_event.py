...
class V1FinancialConnectionsAccountRefreshedOwnershipEventNotification(
    EventNotification,
):
    LOOKUP_TYPE = "v1.financial_connections.account.refreshed_ownership"
...
class V1FinancialConnectionsAccountRefreshedOwnershipEvent(Event):
    LOOKUP_TYPE = "v1.financial_connections.account.refreshed_ownership"
    type: Literal["v1.financial_connections.account.refreshed_ownership"]
