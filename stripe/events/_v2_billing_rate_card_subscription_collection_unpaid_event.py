...
class V2BillingRateCardSubscriptionCollectionUnpaidEventNotification(
    EventNotification,
):
    LOOKUP_TYPE = "v2.billing.rate_card_subscription.collection_unpaid"
    type: Literal["v2.billing.rate_card_subscription.collection_unpaid"]
...
class V2BillingRateCardSubscriptionCollectionUnpaidEvent(Event):
    LOOKUP_TYPE = "v2.billing.rate_card_subscription.collection_unpaid"
    type: Literal["v2.billing.rate_card_subscription.collection_unpaid"]
