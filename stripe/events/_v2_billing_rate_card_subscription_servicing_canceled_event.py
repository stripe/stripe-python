...
class V2BillingRateCardSubscriptionServicingCanceledEventNotification(
    EventNotification,
):
    LOOKUP_TYPE = "v2.billing.rate_card_subscription.servicing_canceled"
    type: Literal["v2.billing.rate_card_subscription.servicing_canceled"]
...
class V2BillingRateCardSubscriptionServicingCanceledEvent(Event):
    LOOKUP_TYPE = "v2.billing.rate_card_subscription.servicing_canceled"
    type: Literal["v2.billing.rate_card_subscription.servicing_canceled"]
