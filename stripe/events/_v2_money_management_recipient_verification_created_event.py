...
class V2MoneyManagementRecipientVerificationCreatedEventNotification(
    ...
    LOOKUP_TYPE = "v2.money_management.recipient_verification.created"
    type: Literal["v2.money_management.recipient_verification.created"]
...
class V2MoneyManagementRecipientVerificationCreatedEvent(Event):
    LOOKUP_TYPE = "v2.money_management.recipient_verification.created"
    type: Literal["v2.money_management.recipient_verification.created"]
