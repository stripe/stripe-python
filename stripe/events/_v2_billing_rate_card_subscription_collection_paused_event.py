...
class V2BillingRateCardSubscriptionCollectionPausedEventNotification(
    EventNotification,
):
    LOOKUP_TYPE = "v2.billing.rate_card_subscription.collection_paused"
    type: Literal["v2.billing.rate_card_subscription.collection_paused"]
...
class V2BillingRateCardSubscriptionCollectionPausedEvent(Event):
    LOOKUP_TYPE = "v2.billing.rate_card_subscription.collection_paused"
    type: Literal["v2.billing.rate_card_subscription.collection_paused"]
