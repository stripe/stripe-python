...
class V1FinancialConnectionsAccountReactivatedEventNotification(
    EventNotification,
):
    LOOKUP_TYPE = "v1.financial_connections.account.reactivated"
    type: Literal["v1.financial_connections.account.reactivated"]
    ...
    @override
    def fetch_event(self) -> "V1FinancialConnectionsAccountReactivatedEvent":
        return cast(
...
class V1FinancialConnectionsAccountReactivatedEvent(Event):
    LOOKUP_TYPE = "v1.financial_connections.account.reactivated"
    type: Literal["v1.financial_connections.account.reactivated"]
