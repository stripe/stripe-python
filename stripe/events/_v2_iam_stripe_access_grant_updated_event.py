...
class V2IamStripeAccessGrantUpdatedEvent(Event):
    ...
    class V2IamStripeAccessGrantUpdatedEventData(StripeObject):
        stripe_access_grant: str
        """
        ID of updated Stripe Access Grant.
        """

    data: V2IamStripeAccessGrantUpdatedEventData
    """
    ...
    def _construct_from(
        ...
        *,
        ...
        if hasattr(evt, "data"):
            evt.data = V2IamStripeAccessGrantUpdatedEvent.V2IamStripeAccessGrantUpdatedEventData._construct_from(
                values=evt.data,
                last_response=last_response,
                requestor=requestor,
                api_mode=api_mode,
