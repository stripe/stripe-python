...
class V2CoreVaultNetworkTokenAuthorizationRequirementsChangedEventNotification(
    EventNotification,
):
    LOOKUP_TYPE = (
...
class V2CoreVaultNetworkTokenAuthorizationRequirementsChangedEvent(Event):
    LOOKUP_TYPE = (
        "v2.core.vault.network_token.authorization_requirements_changed"
    )
    type: Literal[
