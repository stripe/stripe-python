...
class V2MoneyManagementReceivedDebitCreatedEventNotification(
    EventNotification
):
    LOOKUP_TYPE = "v2.money_management.received_debit.created"
    type: Literal["v2.money_management.received_debit.created"]
    ...
    @override
    def fetch_event(self) -> "V2MoneyManagementReceivedDebitCreatedEvent":
        return cast(
...
class V2MoneyManagementReceivedDebitCreatedEvent(Event):
    LOOKUP_TYPE = "v2.money_management.received_debit.created"
    type: Literal["v2.money_management.received_debit.created"]
