...
class V2BillingRateCardSubscriptionActivatedEventNotification(
    EventNotification,
):
    LOOKUP_TYPE = "v2.billing.rate_card_subscription.activated"
    type: Literal["v2.billing.rate_card_subscription.activated"]
    ...
    @override
    def fetch_event(self) -> "V2BillingRateCardSubscriptionActivatedEvent":
        return cast(
...
class V2BillingRateCardSubscriptionActivatedEvent(Event):
    LOOKUP_TYPE = "v2.billing.rate_card_subscription.activated"
    type: Literal["v2.billing.rate_card_subscription.activated"]
