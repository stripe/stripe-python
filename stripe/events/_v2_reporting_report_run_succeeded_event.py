...
class V2ReportingReportRunSucceededEventNotification(EventNotification):
    ...
    @override
    def fetch_event(self) -> "V2ReportingReportRunSucceededEvent":
        return cast(
    ...
    @override
    async def fetch_event_async(self) -> "V2ReportingReportRunSucceededEvent":
        return cast(
            "V2ReportingReportRunSucceededEvent",
