...
class V2PaymentsOffSessionPaymentRequiresCaptureEventNotification(
    EventNotification,
):
    LOOKUP_TYPE = "v2.payments.off_session_payment.requires_capture"
    ...
    @override
    def fetch_event(self) -> "V2PaymentsOffSessionPaymentRequiresCaptureEvent":
        return cast(
...
class V2PaymentsOffSessionPaymentRequiresCaptureEvent(Event):
    LOOKUP_TYPE = "v2.payments.off_session_payment.requires_capture"
    type: Literal["v2.payments.off_session_payment.requires_capture"]
