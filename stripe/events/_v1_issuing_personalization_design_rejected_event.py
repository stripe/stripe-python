...
class V1IssuingPersonalizationDesignRejectedEventNotification(
    ...
    LOOKUP_TYPE = "v1.issuing_personalization_design.rejected"
    type: Literal["v1.issuing_personalization_design.rejected"]
    ...
    @override
    def fetch_event(self) -> "V1IssuingPersonalizationDesignRejectedEvent":
        return cast(
...
class V1IssuingPersonalizationDesignRejectedEvent(Event):
    LOOKUP_TYPE = "v1.issuing_personalization_design.rejected"
    type: Literal["v1.issuing_personalization_design.rejected"]
