...
class V2PaymentsSettlementAllocationIntentSplitCanceledEventNotification(
    EventNotification,
):
    LOOKUP_TYPE = "v2.payments.settlement_allocation_intent_split.canceled"
    type: Literal["v2.payments.settlement_allocation_intent_split.canceled"]
...
class V2PaymentsSettlementAllocationIntentSplitCanceledEvent(Event):
    LOOKUP_TYPE = "v2.payments.settlement_allocation_intent_split.canceled"
    type: Literal["v2.payments.settlement_allocation_intent_split.canceled"]

    class V2PaymentsSettlementAllocationIntentSplitCanceledEventData(
        StripeObject,
    ):
    ...
    data: V2PaymentsSettlementAllocationIntentSplitCanceledEventData
    """
    ...
    def _construct_from(
        ...
        *,
        ...
        if hasattr(evt, "data"):
            evt.data = V2PaymentsSettlementAllocationIntentSplitCanceledEvent.V2PaymentsSettlementAllocationIntentSplitCanceledEventData._construct_from(
                values=evt.data,
                last_response=last_response,
                requestor=requestor,
                api_mode=api_mode,
