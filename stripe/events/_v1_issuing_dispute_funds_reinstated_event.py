...
class V1IssuingDisputeFundsReinstatedEventNotification(EventNotification):
    LOOKUP_TYPE = "v1.issuing_dispute.funds_reinstated"
    type: Literal["v1.issuing_dispute.funds_reinstated"]
    ...
    @override
    def fetch_event(self) -> "V1IssuingDisputeFundsReinstatedEvent":
        return cast(
...
class V1IssuingDisputeFundsReinstatedEvent(Event):
    LOOKUP_TYPE = "v1.issuing_dispute.funds_reinstated"
    type: Literal["v1.issuing_dispute.funds_reinstated"]
