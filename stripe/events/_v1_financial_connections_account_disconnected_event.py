...
class V1FinancialConnectionsAccountDisconnectedEventNotification(
    ...
    LOOKUP_TYPE = "v1.financial_connections.account.disconnected"
    type: Literal["v1.financial_connections.account.disconnected"]
    ...
    @override
    def fetch_event(self) -> "V1FinancialConnectionsAccountDisconnectedEvent":
        return cast(
...
class V1FinancialConnectionsAccountDisconnectedEvent(Event):
    LOOKUP_TYPE = "v1.financial_connections.account.disconnected"
    type: Literal["v1.financial_connections.account.disconnected"]
