...
class QuoteService(StripeService):
    ...
    class CreateParams(TypedDict):
        ...
        """
        phases: NotRequired["List[QuoteService.CreateParamsPhase]"]
        """
    ...
    class CreateParamsPhase(TypedDict):
        ...
        """
        discounts: NotRequired[
            "Literal['']|List[QuoteService.CreateParamsPhaseDiscount]"
        ]
        """
        ...
        """
        invoice_settings: NotRequired[
            "QuoteService.CreateParamsPhaseInvoiceSettings"
        ]
        """
        All invoices will be billed using the specified settings.
        """
        ...
        """
        line_items: List["QuoteService.CreateParamsPhaseLineItem"]
        """
    ...
    class CreateParamsPhaseDiscount(TypedDict):
        ...
        """
        discount_end: NotRequired[
            "QuoteService.CreateParamsPhaseDiscountDiscountEnd"
        ]
        """
        Details to determine how long the discount should be applied for.
        """
    ...
    class CreateParamsPhaseDiscountDiscountEnd(TypedDict):
        duration: NotRequired[
            "QuoteService.CreateParamsPhaseDiscountDiscountEndDuration"
        ]
        """
        Time span for the redeemed discount.
        """
    ...
    class CreateParamsPhaseLineItem(TypedDict):
        discounts: NotRequired[
            "Literal['']|List[QuoteService.CreateParamsPhaseLineItemDiscount]"
        ]
        """
        The discounts applied to this line item.
        """
        ...
        price_data: NotRequired[
            "QuoteService.CreateParamsPhaseLineItemPriceData"
        ]
        """
        Data used to generate a new [Price](https://stripe.com/docs/api/prices) object inline. One of `price` or `price_data` is required.
        """
    ...
    class CreateParamsPhaseLineItemDiscount(TypedDict):
        ...
        """
        discount_end: NotRequired[
            "QuoteService.CreateParamsPhaseLineItemDiscountDiscountEnd"
        ]
        """
        Details to determine how long the discount should be applied for.
        """
    ...
    class CreateParamsPhaseLineItemDiscountDiscountEnd(TypedDict):
        duration: NotRequired[
            "QuoteService.CreateParamsPhaseLineItemDiscountDiscountEndDuration"
        ]
        """
        Time span for the redeemed discount.
        """
    ...
    class CreateParamsPhaseLineItemPriceData(TypedDict):
        ...
        """
        recurring: NotRequired[
            "QuoteService.CreateParamsPhaseLineItemPriceDataRecurring"
        ]
        """
        The recurring components of a price such as `interval` and `interval_count`.
        """
    ...
    class UpdateParams(TypedDict):
        ...
        The account on behalf of which to charge.
        """
        phases: NotRequired["List[QuoteService.UpdateParamsPhase]"]
        """
        List representing phases of the Quote. Each phase can be customized to have different durations, prices, and coupons.
        """
        subscription_data: NotRequired[
    ...
    class UpdateParamsPhase(TypedDict):
        ...
        """
        discounts: NotRequired[
            "Literal['']|List[QuoteService.UpdateParamsPhaseDiscount]"
        ]
        """
        The coupons to redeem into discounts for the schedule phase. If not specified, inherits the discount from the subscription's customer. Pass an empty string to avoid inheriting any discounts.
        """
        ...
        """
        invoice_settings: NotRequired[
            "QuoteService.UpdateParamsPhaseInvoiceSettings"
        ]
        """
        All invoices will be billed using the specified settings.
        """
        ...
        Integer representing the multiplier applied to the price interval. For example, `iterations=2` applied to a price with `interval=month` and `interval_count=3` results in a phase of duration `2 * 3 months = 6 months`. If set, `end_date` must not be set.
        """
        line_items: List["QuoteService.UpdateParamsPhaseLineItem"]
        """
        A list of line items the customer is being quoted for within this phase. Each line item includes information about the product, the quantity, and the resulting cost.
        """
        metadata: NotRequired["Dict[str, str]"]
    ...
    class UpdateParamsPhaseDiscount(TypedDict):
        ...
        """
        discount_end: NotRequired[
            "QuoteService.UpdateParamsPhaseDiscountDiscountEnd"
        ]
        """
        Details to determine how long the discount should be applied for.
        """
    ...
    class UpdateParamsPhaseDiscountDiscountEnd(TypedDict):
        duration: NotRequired[
            "QuoteService.UpdateParamsPhaseDiscountDiscountEndDuration"
        ]
        """
        Time span for the redeemed discount.
        """
    ...
    class UpdateParamsPhaseLineItem(TypedDict):
        discounts: NotRequired[
            "Literal['']|List[QuoteService.UpdateParamsPhaseLineItemDiscount]"
        ]
        """
        The discounts applied to this line item.
        """
        ...
        """
        price_data: NotRequired[
            "QuoteService.UpdateParamsPhaseLineItemPriceData"
        ]
        """
        Data used to generate a new [Price](https://stripe.com/docs/api/prices) object inline. One of `price` or `price_data` is required.
        """
    ...
    class UpdateParamsPhaseLineItemDiscount(TypedDict):
        coupon: NotRequired["str"]
        """
        ID of the coupon to create a new discount for.
        """
        ...
        """
        discount_end: NotRequired[
            "QuoteService.UpdateParamsPhaseLineItemDiscountDiscountEnd"
        ]
        """
        Details to determine how long the discount should be applied for.
        """
    ...
    class UpdateParamsPhaseLineItemDiscountDiscountEnd(TypedDict):
        duration: NotRequired[
            "QuoteService.UpdateParamsPhaseLineItemDiscountDiscountEndDuration"
        ]
        """
        Time span for the redeemed discount.
        """
    ...
    class UpdateParamsPhaseLineItemDiscountDiscountEndDuration(TypedDict):
        interval: Literal["day", "month", "week", "year"]
        """
        Specifies a type of interval unit. Either `day`, `week`, `month` or `year`.
        """
    ...
    class UpdateParamsPhaseLineItemPriceData(TypedDict):
        currency: str
        """
        Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://stripe.com/docs/currencies).
        """
        ...
        """
        recurring: NotRequired[
            "QuoteService.UpdateParamsPhaseLineItemPriceDataRecurring"
        ]
        """
        The recurring components of a price such as `interval` and `interval_count`.
        """
    ...
    class UpdateParamsPhaseLineItemPriceDataRecurring(TypedDict):
        interval: Literal["day", "month", "week", "year"]
        """
        Specifies billing frequency. Either `day`, `week`, `month` or `year`.
        """
