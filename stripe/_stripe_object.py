...
import stripe
from stripe import _api_requestor as api_requestor, util  # pyright: ignore[reportPrivateUsage]
    ...
    class ReprJSONEncoder(json.JSONEncoder):
        def default(self, o: Any) -> Any:
            if isinstance(o, datetime.datetime):
                return api_requestor._encode_datetime(o)  # pyright: ignore[reportPrivateUsage]
