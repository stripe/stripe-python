...
if TYPE_CHECKING:
    from stripe.param._file_create_params import FileCreateParams
    from stripe.param._file_list_params import FileListParams
    from stripe.param._file_retrieve_params import FileRetrieveParams
