...
if TYPE_CHECKING:
    from stripe._credit_note_create_params import CreditNoteCreateParams
    from stripe._credit_note_line_item import CreditNoteLineItem
    from stripe._credit_note_list_lines_params import CreditNoteListLinesParams
    from stripe._credit_note_list_params import CreditNoteListParams
    from stripe._credit_note_modify_params import CreditNoteModifyParams
    from stripe._credit_note_preview_lines_params import (
        CreditNotePreviewLinesParams,
    )
    from stripe._credit_note_preview_params import CreditNotePreviewParams
    from stripe._credit_note_retrieve_params import CreditNoteRetrieveParams
