...
if TYPE_CHECKING:
    ...
    from stripe._quote_accept_params import QuoteAcceptParams
    from stripe._quote_cancel_params import QuoteCancelParams
    from stripe._quote_create_params import QuoteCreateParams
    from stripe._quote_finalize_quote_params import QuoteFinalizeQuoteParams
    from stripe._quote_list_computed_upfront_line_items_params import (
        QuoteListComputedUpfrontLineItemsParams,
    )
    from stripe._quote_list_line_items_params import QuoteListLineItemsParams
    from stripe._quote_list_params import QuoteListParams
    from stripe._quote_modify_params import QuoteModifyParams
    from stripe._quote_pdf_params import QuotePdfParams
    from stripe._quote_retrieve_params import QuoteRetrieveParams
