...
if TYPE_CHECKING:
    from stripe._file_create_params import FileCreateParams
    from stripe._file_link import FileLink
    from stripe._file_list_params import FileListParams
    from stripe._file_retrieve_params import FileRetrieveParams
