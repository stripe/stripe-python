...
class Subscription(
    ...
    class CreateParams(RequestOptions):
        ...
        billing_schedules: NotRequired[
            List["Subscription.CreateParamsBillingSchedule"]
        ]
        """
    ...
    class CreateParamsBillingSchedule(TypedDict):
        applies_to: NotRequired[
            List["Subscription.CreateParamsBillingScheduleAppliesTo"]
        ]
        """
        Configure billing schedule differently for individual subscription items.
        """
        bill_until: "Subscription.CreateParamsBillingScheduleBillUntil"
        """
    ...
    class CreateParamsBillingScheduleBillUntil(TypedDict):
        duration: NotRequired[
            "Subscription.CreateParamsBillingScheduleBillUntilDuration"
        ]
        """
        Specifies the billing period.
        """
    ...
    class CreateParamsPaymentSettingsPaymentMethodOptions(TypedDict):
        ...
        id_bank_transfer: NotRequired[
            "Literal['']|Subscription.CreateParamsPaymentSettingsPaymentMethodOptionsIdBankTransfer"
        ]
        """
    ...
    class ModifyParams(RequestOptions):
        ...
        """
        billing_schedules: NotRequired[
            "Literal['']|List[Subscription.ModifyParamsBillingSchedule]"
        ]
        """
        Sets the billing schedules for the subscription.
        """
    ...
    class ModifyParamsBillingSchedule(TypedDict):
        applies_to: NotRequired[
            List["Subscription.ModifyParamsBillingScheduleAppliesTo"]
        ]
        """
        Configure billing schedule differently for individual subscription items.
        """
        bill_until: NotRequired[
            "Subscription.ModifyParamsBillingScheduleBillUntil"
        ]
        """
        The end date for the billing schedule.
        """
    ...
    class ModifyParamsBillingScheduleAppliesTo(TypedDict):
        price: NotRequired[str]
        """
        The ID of the price object.
        """
    ...
    class ModifyParamsBillingScheduleBillUntil(TypedDict):
        duration: NotRequired[
            "Subscription.ModifyParamsBillingScheduleBillUntilDuration"
        ]
        """
        Specifies the billing period.
        """
    ...
    class ModifyParamsBillingScheduleBillUntilDuration(TypedDict):
        interval: Literal["day", "month", "week", "year"]
        """
        Specifies billing duration. Either `day`, `week`, `month` or `year`.
        """
    ...
    class ModifyParamsPaymentSettingsPaymentMethodOptions(TypedDict):
        ...
        """
        id_bank_transfer: NotRequired[
            "Literal['']|Subscription.ModifyParamsPaymentSettingsPaymentMethodOptionsIdBankTransfer"
        ]
        """
        This sub-hash contains details about the Indonesia bank transfer payment method options to pass to the invoice's PaymentIntent.
        """
