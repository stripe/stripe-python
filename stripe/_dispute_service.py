...
if TYPE_CHECKING:
    from stripe.params.v1._dispute_close_params import DisputeCloseParams
    from stripe.params.v1._dispute_list_params import DisputeListParams
    from stripe.params.v1._dispute_retrieve_params import DisputeRetrieveParams
    from stripe.params.v1._dispute_update_params import DisputeUpdateParams
