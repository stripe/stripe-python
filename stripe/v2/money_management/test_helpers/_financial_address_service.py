...
class FinancialAddressService(StripeService):
    def credit(
        ...
        return cast(
            ...
            self._request(
                "post",
                "/v2/money_management/test_helpers/financial_addresses/{id}/credit".format(
                    id=sanitize_id(id),
                ),
                base_address="api",
                params=params,
    ...
    def generate_microdeposits(
        ...
        return cast(
            ...
            self._request(
                "post",
                "/v2/money_management/test_helpers/financial_addresses/{id}/generate_microdeposits".format(
                    id=sanitize_id(id),
                ),
                base_address="api",
                params=params,
