...
class PersonService(StripeService):
    ...
    class UpdateParams(TypedDict):
        ...
        """
        script_addresses: NotRequired[
            "PersonService.UpdateParamsScriptAddresses"
        ]
        """
        The script addresses (e.g., non-Latin characters) associated with the person.
        """
        script_names: NotRequired["PersonService.UpdateParamsScriptNames"]
        """
        The script names (e.g. non-Latin characters) associated with the person.
        """
        surname: NotRequired[str]
    ...
    class UpdateParamsDocuments(TypedDict):
        ...
        """
        primary_verification: NotRequired[
            "PersonService.UpdateParamsDocumentsPrimaryVerification"
        ]
        """
        An identifying document showing the person's name, either a passport or local ID card.
        """
    ...
    class UpdateParamsScriptAddresses(TypedDict):
        kana: NotRequired["PersonService.UpdateParamsScriptAddressesKana"]
        """
        Kana Address.
        """
        kanji: NotRequired["PersonService.UpdateParamsScriptAddressesKanji"]
        """
        Kanji Address.
        """
    ...
    class UpdateParamsScriptNames(TypedDict):
        kana: NotRequired["PersonService.UpdateParamsScriptNamesKana"]
        """
        Persons name in kana script.
        """
        kanji: NotRequired["PersonService.UpdateParamsScriptNamesKanji"]
        """
        Persons name in kanji script.
        """
