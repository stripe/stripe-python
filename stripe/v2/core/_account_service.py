...
class AccountService(StripeService):
    ...
    class UpdateParamsIdentityBusinessDetails(TypedDict):
        ...
        """
        id_numbers: NotRequired[
            List["AccountService.UpdateParamsIdentityBusinessDetailsIdNumber"]
        ]
        """
        The ID numbers of a business entity.
        """
    ...
    class UpdateParamsIdentityIndividual(TypedDict):
        ...
        """
        additional_names: NotRequired[
            List["AccountService.UpdateParamsIdentityIndividualAdditionalName"]
        ]
        """
        Additional names (e.g. aliases) associated with the individual.
        """
        address: NotRequired[
            "AccountService.UpdateParamsIdentityIndividualAddress"
        ]
        """
        The individual's residential address.
        """
        ...
        """
        documents: NotRequired[
            "AccountService.UpdateParamsIdentityIndividualDocuments"
        ]
        """
        Documents that may be submitted to satisfy various informational requests.
        """
