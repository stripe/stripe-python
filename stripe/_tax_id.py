...
if TYPE_CHECKING:
    ...
    from stripe._tax_id_create_params import TaxIdCreateParams
    from stripe._tax_id_delete_params import TaxIdDeleteParams
    from stripe._tax_id_list_params import TaxIdListParams
    from stripe._tax_id_retrieve_params import TaxIdRetrieveParams
