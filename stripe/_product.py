...
if TYPE_CHECKING:
    ...
    from stripe._product_create_params import ProductCreateParams
    from stripe._product_delete_feature_params import (
        ProductDeleteFeatureParams,
    )
    from stripe._product_delete_params import ProductDeleteParams
    from stripe._product_feature import ProductFeature
    from stripe._product_list_features_params import ProductListFeaturesParams
    from stripe._product_list_params import ProductListParams
    from stripe._product_modify_params import ProductModifyParams
    from stripe._product_retrieve_feature_params import (
        ProductRetrieveFeatureParams,
    )
    from stripe._product_retrieve_params import ProductRetrieveParams
    from stripe._product_search_params import ProductSearchParams
