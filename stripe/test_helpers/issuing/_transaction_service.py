...
class TransactionService(StripeService):
    ...
    class CreateForceCaptureParamsPurchaseDetails(TypedDict):
        ...
        """
        receipt: NotRequired[
            "List[TransactionService.CreateForceCaptureParamsPurchaseDetailsReceipt]"
        ]
        """
    ...
    class CreateForceCaptureParamsPurchaseDetailsFlight(TypedDict):
        ...
        segments: NotRequired[
            "List[TransactionService.CreateForceCaptureParamsPurchaseDetailsFlightSegment]"
        ]
        """
    ...
    class CreateUnlinkedRefundParamsPurchaseDetails(TypedDict):
        ...
        """
        receipt: NotRequired[
            "List[TransactionService.CreateUnlinkedRefundParamsPurchaseDetailsReceipt]"
        ]
        """
        The line items in the purchase.
        """
