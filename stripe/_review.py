...
if TYPE_CHECKING:
    ...
    from stripe._review_approve_params import ReviewApproveParams
    from stripe._review_list_params import ReviewListParams
    from stripe._review_retrieve_params import ReviewRetrieveParams
