...
if TYPE_CHECKING:
    from stripe.tax._calculation_create_params import CalculationCreateParams
    from stripe.tax._calculation_line_item import CalculationLineItem
    from stripe.tax._calculation_list_line_items_params import (
        CalculationListLineItemsParams,
    )
    from stripe.tax._calculation_retrieve_params import (
