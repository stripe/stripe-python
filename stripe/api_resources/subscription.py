...
class Subscription(
    ...
    class CreateParamsItem(TypedDict):
        ...
        price_data: NotRequired["Subscription.CreateParamsItemPriceData|None"]
    ...
    class ListParams(RequestOptions):
        automatic_tax: NotRequired["Subscription.ListParamsAutomaticTax|None"]
        collection_method: NotRequired[
            "Literal['charge_automatically', 'send_invoice']|None"
        ]
    ...
    class ModifyParams(RequestOptions):
        ...
        billing_cycle_anchor: NotRequired["Literal['now', 'unchanged']|None"]
        billing_thresholds: NotRequired[
    ...
    class ModifyParamsItem(TypedDict):
        ...
        plan: NotRequired["str|None"]
        price: NotRequired["str|None"]
        price_data: NotRequired["Subscription.ModifyParamsItemPriceData|None"]
        quantity: NotRequired["int|None"]
        tax_rates: NotRequired["Literal['']|List[str]|None"]
