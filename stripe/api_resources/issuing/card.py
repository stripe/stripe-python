...
class Card(
    ...
    class CreateParams(RequestOptions):
        ...
        personalization_design: NotRequired["str|None"]
    ...
    class CreateParamsShipping(TypedDict):
        ...
        address_validation: NotRequired[
            "Card.CreateParamsShippingAddressValidation|None"
        ]
        ...
        service: NotRequired["Literal['express', 'priority', 'standard']|None"]
    ...
    class ListParams(RequestOptions):
        ...
        status: NotRequired["Literal['active', 'canceled', 'inactive']|None"]
    ...
    class ModifyParams(RequestOptions):
        ...
        shipping: NotRequired["Card.ModifyParamsShipping|None"]
        spending_controls: NotRequired[
    ...
    class ModifyParamsShipping(TypedDict):
        ...
        address_validation: NotRequired[
            "Card.ModifyParamsShippingAddressValidation|None"
        ]
        customs: NotRequired["Card.ModifyParamsShippingCustoms|None"]
        name: str
        phone_number: NotRequired["str|None"]
        require_signature: NotRequired["bool|None"]
        service: NotRequired["Literal['express', 'priority', 'standard']|None"]
