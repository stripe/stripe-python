...
class Order(
    ...
    class CreateParams(RequestOptions):
        ...
        credits: NotRequired["Literal['']|List[Order.CreateParamsCredit]|None"]
        currency: str
    ...
    class CreateParamsTaxDetails(TypedDict):
        ...
        tax_ids: NotRequired["List[Order.CreateParamsTaxDetailsTaxId]|None"]
    ...
    class CreateParamsLineItem(TypedDict):
        ...
        product_data: NotRequired["Order.CreateParamsLineItemProductData|None"]
    ...
    class CreateParamsBillingDetails(TypedDict):
        address: NotRequired["Order.CreateParamsBillingDetailsAddress|None"]
    ...
    class ModifyParams(RequestOptions):
        ...
        credits: NotRequired["Literal['']|List[Order.ModifyParamsCredit]|None"]
        currency: NotRequired["str|None"]
        customer: NotRequired["str|None"]
        description: NotRequired["Literal['']|str|None"]
        discounts: NotRequired[
    ...
    class ModifyParamsTaxDetails(TypedDict):
        ...
        tax_ids: NotRequired["List[Order.ModifyParamsTaxDetailsTaxId]|None"]
    ...
    class ModifyParamsLineItem(TypedDict):
        ...
        product: NotRequired["str|None"]
        product_data: NotRequired["Order.ModifyParamsLineItemProductData|None"]
        quantity: NotRequired["int|None"]
        tax_rates: NotRequired["Literal['']|List[str]|None"]
    ...
    class ModifyParamsBillingDetails(TypedDict):
        address: NotRequired["Order.ModifyParamsBillingDetailsAddress|None"]
        email: NotRequired["str|None"]
        name: NotRequired["str|None"]
        phone: NotRequired["str|None"]
