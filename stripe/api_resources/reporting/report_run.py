...
class ReportRun(
    ...
    if TYPE_CHECKING:
        ...
        class CreateParams(RequestOptions):
            ...
            """
            parameters: NotRequired["ReportRun.CreateParamsParameters|None"]
            """
        ...
        class CreateParamsParameters(TypedDict):
            ...
            Currency of objects to be included in the report run.
            """
            interval_end: NotRequired["int|None"]
            """
            Ending timestamp of data to be included in the report run (exclusive).
            """
            interval_start: NotRequired["int|None"]
            """
        ...
        class ListParams(RequestOptions):
            created: NotRequired["ReportRun.ListParamsCreated|int|None"]
