...
class Charge(
    ...
    class CaptureParams(RequestOptions):
        ...
        payment_details: NotRequired["Charge.CaptureParamsPaymentDetails|None"]
    ...
    class CaptureParamsPaymentDetails(TypedDict):
        ...
        flight: NotRequired["Charge.CaptureParamsPaymentDetailsFlight|None"]
        lodging: NotRequired["Charge.CaptureParamsPaymentDetailsLodging|None"]
    ...
    class ModifyParams(RequestOptions):
        ...
        metadata: NotRequired["Literal['']|Dict[str, str]|None"]
        payment_details: NotRequired["Charge.ModifyParamsPaymentDetails|None"]
        receipt_email: NotRequired["str|None"]
    ...
    class ModifyParamsPaymentDetails(TypedDict):
        ...
        lodging: NotRequired["Charge.ModifyParamsPaymentDetailsLodging|None"]
