...
OBJECT_CLASSES = {
    ...
    stripe.AccountNotice.OBJECT_NAME: stripe.AccountNotice,
    ...
    stripe.billing.analytics.MeterUsage.OBJECT_NAME: stripe.billing.analytics.MeterUsage,
    stripe.billing.analytics.MeterUsageRow.OBJECT_NAME: stripe.billing.analytics.MeterUsageRow,
    ...
    stripe.capital.FinancingTransaction.OBJECT_NAME: stripe.capital.FinancingTransaction,
    ...
    stripe.privacy.RedactionJob.OBJECT_NAME: stripe.privacy.RedactionJob,
    stripe.privacy.RedactionJobValidationError.OBJECT_NAME: stripe.privacy.RedactionJobValidationError,
...
V2_OBJECT_CLASSES = {
    ...
    stripe.v2.billing.PricingPlan.OBJECT_NAME: stripe.v2.billing.PricingPlan,
    stripe.v2.billing.PricingPlanComponent.OBJECT_NAME: stripe.v2.billing.PricingPlanComponent,
    stripe.v2.billing.PricingPlanSubscription.OBJECT_NAME: stripe.v2.billing.PricingPlanSubscription,
    stripe.v2.billing.PricingPlanVersion.OBJECT_NAME: stripe.v2.billing.PricingPlanVersion,
    stripe.v2.billing.Profile.OBJECT_NAME: stripe.v2.billing.Profile,
    stripe.v2.billing.RateCard.OBJECT_NAME: stripe.v2.billing.RateCard,
    stripe.v2.billing.RateCardRate.OBJECT_NAME: stripe.v2.billing.RateCardRate,
    stripe.v2.billing.RateCardSubscription.OBJECT_NAME: stripe.v2.billing.RateCardSubscription,
    stripe.v2.billing.RateCardVersion.OBJECT_NAME: stripe.v2.billing.RateCardVersion,
    ...
    stripe.v2.FinancialAddressCreditSimulation.OBJECT_NAME: stripe.v2.FinancialAddressCreditSimulation,
    stripe.v2.FinancialAddressGeneratedMicrodeposits.OBJECT_NAME: stripe.v2.FinancialAddressGeneratedMicrodeposits,
    stripe.v2.money_management.Adjustment.OBJECT_NAME: stripe.v2.money_management.Adjustment,
    stripe.v2.money_management.FinancialAccount.OBJECT_NAME: stripe.v2.money_management.FinancialAccount,
    stripe.v2.money_management.FinancialAddress.OBJECT_NAME: stripe.v2.money_management.FinancialAddress,
    stripe.v2.money_management.InboundTransfer.OBJECT_NAME: stripe.v2.money_management.InboundTransfer,
    stripe.v2.money_management.OutboundPayment.OBJECT_NAME: stripe.v2.money_management.OutboundPayment,
    stripe.v2.money_management.OutboundPaymentQuote.OBJECT_NAME: stripe.v2.money_management.OutboundPaymentQuote,
    stripe.v2.money_management.OutboundSetupIntent.OBJECT_NAME: stripe.v2.money_management.OutboundSetupIntent,
    stripe.v2.money_management.OutboundTransfer.OBJECT_NAME: stripe.v2.money_management.OutboundTransfer,
