...
V2_OBJECT_CLASSES = {
    ...
    stripe.v2.FinancialAccount.OBJECT_NAME: stripe.v2.FinancialAccount,
    stripe.v2.FinancialAddress.OBJECT_NAME: stripe.v2.FinancialAddress,
    ...
    stripe.v2.InboundTransfer.OBJECT_NAME: stripe.v2.InboundTransfer,
