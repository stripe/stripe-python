...
class AccountUpdateParamsCapabilities(TypedDict):
    ...
    """
    bizum_payments: NotRequired["AccountUpdateParamsCapabilitiesBizumPayments"]
    """
...
class AccountUpdateParamsCapabilitiesBizumPayments(TypedDict):
    requested: NotRequired[bool]
    """
    Passing true requests the capability for the account, if it is not already requested. A requested capability may not immediately become active. Any requirements to activate the capability are returned in the `requirements` arrays.
    """
...
class AccountUpdateParamsCapabilitiesCardPaymentsProtections(TypedDict):
    psp_migration: (
...
class AccountUpdateParamsCapabilitiesCardPaymentsProtectionsPspMigration(
    TypedDict,
):
    requested: bool
    """
...
class AccountUpdateParamsCapabilitiesScalapayPayments(TypedDict):
    requested: NotRequired[bool]
    """
    Passing true requests the capability for the account, if it is not already requested. A requested capability may not immediately become active. Any requirements to activate the capability are returned in the `requirements` arrays.
    """
...
class AccountUpdateParamsIndividualSelfReportedIncome(TypedDict):
    amount: int
    """
...
class AccountUpdateParamsIndividualSelfReportedMonthlyHousingPayment(
    TypedDict
):
    amount: int
    """
...
class AccountUpdateParamsSettingsSmartDisputes(TypedDict):
...
class AccountUpdateParamsSettingsSmartDisputesAutoRespond(TypedDict):
