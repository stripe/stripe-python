...
class PaymentIntentModifyParamsAmountDetailsLineItemPaymentMethodOptionsCardEvCharging(
    TypedDict,
):
...
class PaymentIntentModifyParamsPaymentDetails(TypedDict):
    ...
    """
    fleet_data: NotRequired[
        "Literal['']|List[PaymentIntentModifyParamsPaymentDetailsFleetDatum]"
    ]
    """
...
class PaymentIntentModifyParamsPaymentDetailsCarRentalDatumTotalTaxTaxItem(
    TypedDict,
):
    amount: NotRequired[int]
    """
...
class PaymentIntentModifyParamsPaymentDetailsFleetDatum(TypedDict):
    ...
    """
    vat: NotRequired["PaymentIntentModifyParamsPaymentDetailsFleetDatumVat"]
    """
    VAT and Invoice on Behalf (IOB) details.
    """


class PaymentIntentModifyParamsPaymentDetailsFleetDatumPrimaryFuelFields(
    TypedDict,
):
    brand: NotRequired[
...
class PaymentIntentModifyParamsPaymentDetailsFleetDatumStation(TypedDict):
...
class PaymentIntentModifyParamsPaymentDetailsFleetDatumStationServiceLocation(
    TypedDict,
):
    city: NotRequired[str]
    """
...
class PaymentIntentModifyParamsPaymentDetailsFleetDatumVat(TypedDict):
    iob_indicator: Union[
        Literal[
            "issuer_to_iob",
...
class PaymentIntentModifyParamsPaymentDetailsFlightDatumTotalTaxTaxItem(
    TypedDict,
):
    amount: NotRequired[int]
    """
...
class PaymentIntentModifyParamsPaymentDetailsLodgingDatumTotalTaxTaxItem(
    TypedDict,
):
    amount: NotRequired[int]
    """
...
class PaymentIntentModifyParamsPaymentDetailsMoneyServices(TypedDict):
    account_funding: NotRequired[
        "Literal['']|PaymentIntentModifyParamsPaymentDetailsMoneyServicesAccountFunding"
    ]
    """
    Account funding transaction details including sender information.
    """
    beneficiary_details: NotRequired[
        "Literal['']|PaymentIntentModifyParamsPaymentDetailsMoneyServicesBeneficiaryDetails"
    ]
    """
    Inline identity details for the beneficiary of this transaction.
    """
    transaction_type: NotRequired[
        "Literal['']|Literal['account_funding', 'debt_repayment']|str"
    ]
    """
...
class PaymentIntentModifyParamsPaymentDetailsMoneyServicesAccountFunding(
    TypedDict,
):
    sender_details: NotRequired[
        "Literal['']|PaymentIntentModifyParamsPaymentDetailsMoneyServicesAccountFundingSenderDetails"
    ]
    """
...
class PaymentIntentModifyParamsPaymentDetailsMoneyServicesAccountFundingSenderDetailsAddress(
    TypedDict,
):
    city: NotRequired[str]
    """
...
class PaymentIntentModifyParamsPaymentDetailsMoneyServicesAccountFundingSenderDetailsDateOfBirth(
    TypedDict,
):
    day: int
    """
...
class PaymentIntentModifyParamsPaymentDetailsMoneyServicesBeneficiaryDetails(
    TypedDict,
):
    ...
    """
    address: NotRequired[
        "PaymentIntentModifyParamsPaymentDetailsMoneyServicesBeneficiaryDetailsAddress"
    ]
    """
    Address.
    """
...
class PaymentIntentModifyParamsPaymentDetailsMoneyServicesBeneficiaryDetailsDateOfBirth(
    TypedDict,
):
    day: int
    """
...
class PaymentIntentModifyParamsPaymentMethodData(TypedDict):
    ...
    """
    sequra: NotRequired["PaymentIntentModifyParamsPaymentMethodDataSequra"]
    """
    ...
    """
    sunbit: NotRequired["PaymentIntentModifyParamsPaymentMethodDataSunbit"]
    """
    ...
    """
    tamara: NotRequired["PaymentIntentModifyParamsPaymentMethodDataTamara"]
    """
    ...
    """
    vipps: NotRequired["PaymentIntentModifyParamsPaymentMethodDataVipps"]
    """
...
class PaymentIntentModifyParamsPaymentMethodDataGiftCard(TypedDict):
    gift_card: str
    """
...
class PaymentIntentModifyParamsPaymentMethodDataIdBankTransfer(TypedDict):
    bank: NotRequired["Literal['bca', 'bni', 'bri', 'cimb', 'permata']|str"]
    """
...
class PaymentIntentModifyParamsPaymentMethodDataSequra(TypedDict):
    pass
...
class PaymentIntentModifyParamsPaymentMethodDataSunbit(TypedDict):
    pass
...
class PaymentIntentModifyParamsPaymentMethodDataTamara(TypedDict):
    pass
...
class PaymentIntentModifyParamsPaymentMethodDataVipps(TypedDict):
    pass
...
class PaymentIntentModifyParamsPaymentMethodOptions(TypedDict):
    ...
    """
    gift_card: NotRequired[
        "Literal['']|PaymentIntentModifyParamsPaymentMethodOptionsGiftCard"
    ]
    """
    ...
    """
    sequra: NotRequired[
        "Literal['']|PaymentIntentModifyParamsPaymentMethodOptionsSequra"
    ]
    """
    ...
    """
    sunbit: NotRequired[
        "Literal['']|PaymentIntentModifyParamsPaymentMethodOptionsSunbit"
    ]
    """
    ...
    """
    vipps: NotRequired[
        "Literal['']|PaymentIntentModifyParamsPaymentMethodOptionsVipps"
    ]
    """
...
class PaymentIntentModifyParamsPaymentMethodOptionsBillie(TypedDict):
    ...
    company_details: NotRequired[
        "Literal['']|PaymentIntentModifyParamsPaymentMethodOptionsBillieCompanyDetails"
    ]
    """
...
class PaymentIntentModifyParamsPaymentMethodOptionsBillieCompanyDetails(
    TypedDict,
):
...
class PaymentIntentModifyParamsPaymentMethodOptionsBillieCompanyDetailsRegisteredAddress(
    TypedDict,
):
    city: NotRequired[str]
    """
...
class PaymentIntentModifyParamsPaymentMethodOptionsBlikMandateOptions(
    TypedDict,
):
...
class PaymentIntentModifyParamsPaymentMethodOptionsCard(TypedDict):
    ...
    """
    capture_method: NotRequired[
        "Literal['']|Literal['automatic_delayed', 'manual']|str"
    ]
    """
    Controls when the funds are captured from the customer's account.
    ...
    """
    request_card_account_update: NotRequired[Literal["if_available", "never"]]
    """
    ...
    """
    request_reauthorization: NotRequired[
        "Literal['if_available', 'never']|str"
    ]
    """
...
class PaymentIntentModifyParamsPaymentMethodOptionsCardCaptureDelay(TypedDict):
...
class PaymentIntentModifyParamsPaymentMethodOptionsCardPaymentDetails(
    TypedDict,
):
    money_services: NotRequired[
...
class PaymentIntentModifyParamsPaymentMethodOptionsCardPaymentDetailsMoneyServices(
    TypedDict,
):
    account_funding: NotRequired[
...
class PaymentIntentModifyParamsPaymentMethodOptionsCardPaymentDetailsMoneyServicesAccountFunding(
    ...
    digital_asset_category: NotRequired[
        "Literal['blockchain_native', 'nft', 'other_non_fiat', 'stablecoin']|str"
    ]
    """
...
class PaymentIntentModifyParamsPaymentMethodOptionsCardThreeDSecure(TypedDict):
    ...
    """
    exemption_indicator: NotRequired["Literal['low_risk', 'none']|str"]
    """
    ...
    """
    version: Union[Literal["1.0.2", "2.1.0", "2.2.0", "2.3.0", "2.3.1"], str]
    """
...
class PaymentIntentModifyParamsPaymentMethodOptionsCardPresentAadeData(
    TypedDict,
):
...
class PaymentIntentModifyParamsPaymentMethodOptionsCardPresentCaptureDelay(
    TypedDict,
):
    days: NotRequired[int]
    hours: NotRequired[int]
...
class PaymentIntentModifyParamsPaymentMethodOptionsCardPresentPaymentDetailsMoneyServices(
    TypedDict,
):
    account_funding: NotRequired[
...
class PaymentIntentModifyParamsPaymentMethodOptionsCardPresentRouting(
    ...
    requested_priority: NotRequired["Literal['domestic', 'international']|str"]
    """
...
class PaymentIntentModifyParamsPaymentMethodOptionsCrypto(TypedDict):
    amount_reconciliation: NotRequired[
    ...
    """
    mode: NotRequired[
        "Literal['default', 'deposit', 'transaction_verification']|str"
    ]
    """
    ...
    transaction_verification_options: NotRequired[
        "PaymentIntentModifyParamsPaymentMethodOptionsCryptoTransactionVerificationOptions"
    ]
    """
...
class PaymentIntentModifyParamsPaymentMethodOptionsCryptoAmountReconciliation(
    TypedDict,
):
    type: Literal["accept_partial_funding", "exact"]
    """
...
class PaymentIntentModifyParamsPaymentMethodOptionsCryptoDepositOptions(
    ...
    networks: List[
        Union[Literal["base", "ethereum", "polygon", "solana", "tempo"], str]
    ]
    """
...
class PaymentIntentModifyParamsPaymentMethodOptionsGiftCard(TypedDict):
...
class PaymentIntentModifyParamsPaymentMethodOptionsSequra(TypedDict):
    capture_method: NotRequired["Literal['']|Literal['manual']"]
    """
    Controls when the funds are captured from the customer's account.
...
class PaymentIntentModifyParamsPaymentMethodOptionsSunbit(TypedDict):
    capture_method: NotRequired["Literal['']|Literal['manual']"]
    """
    Controls when the funds are captured from the customer's account.
...
class PaymentIntentModifyParamsPaymentMethodOptionsUsBankAccount(TypedDict):
    ...
    transaction_purpose: NotRequired[
        "Literal['']|Literal['goods', 'other', 'services', 'unspecified']|str"
    ]
    """
...
class PaymentIntentModifyParamsPaymentMethodOptionsUsBankAccountFinancialConnectionsManualEntry(
    ...
    mode: Union[Literal["automatic", "custom"], str]
    """
...
class PaymentIntentModifyParamsPaymentMethodOptionsVipps(TypedDict):
    capture_method: NotRequired["Literal['']|Literal['manual']"]
    """
    Controls when the funds are captured from the customer's account.
...
class PaymentIntentModifyParamsPaymentMethodOptionsVippsPaymentDetails(
    TypedDict,
):
    money_services: NotRequired[
...
class PaymentIntentModifyParamsPaymentMethodOptionsVippsPaymentDetailsMoneyServices(
    TypedDict,
):
    account_funding: NotRequired[
...
class PaymentIntentModifyParamsPaymentMethodOptionsVippsPaymentDetailsMoneyServicesAccountFunding(
    TypedDict,
):
    digital_asset_category: NotRequired[
        "Literal['blockchain_native', 'nft', 'other_non_fiat', 'stablecoin']|str"
...
class PaymentIntentModifyParamsPaymentMethodOptionsWechatPay(TypedDict):
    ...
    """
    client: NotRequired["Literal['android', 'ios', 'mini_program', 'web']|str"]
    """
