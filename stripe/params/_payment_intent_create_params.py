...
class PaymentIntentCreateParams(RequestOptions):
    ...
    """
    secret_key_confirmation: NotRequired["Literal['optional', 'required']|str"]
    """
...
class PaymentIntentCreateParamsAmountDetails(TypedDict):
    ...
    surcharge: NotRequired[
        "Literal['']|PaymentIntentCreateParamsAmountDetailsSurcharge"
    ]
    """
    ...
    """
    tip: NotRequired["Literal['']|PaymentIntentCreateParamsAmountDetailsTip"]
    """
...
class PaymentIntentCreateParamsAmountDetailsLineItemPaymentMethodOptionsCardEvCharging(
    TypedDict,
):
...
class PaymentIntentCreateParamsAmountDetailsSurcharge(TypedDict):
    amount: NotRequired["Literal['']|int"]
    """
...
class PaymentIntentCreateParamsAmountDetailsTip(TypedDict):
    amount: NotRequired["Literal['']|int"]
    """
...
class PaymentIntentCreateParamsAutomaticPaymentMethods(TypedDict):
    allow_redirects: NotRequired["Literal['always', 'never']|str"]
    """
...
class PaymentIntentCreateParamsPaymentDetailsFlightDatumTotalTaxTaxItem(
    TypedDict,
):
    amount: NotRequired[int]
    """
...
class PaymentIntentCreateParamsPaymentDetailsLodgingDatumTotalTaxTaxItem(
    TypedDict,
):
    amount: NotRequired[int]
    """
...
class PaymentIntentCreateParamsPaymentDetailsMoneyServices(TypedDict):
    ...
    beneficiary_details: NotRequired[
        "Literal['']|PaymentIntentCreateParamsPaymentDetailsMoneyServicesBeneficiaryDetails"
    ]
    """
...
class PaymentIntentCreateParamsPaymentDetailsMoneyServicesBeneficiaryDetails(
    ...
    """
    date_of_birth: NotRequired[
        "PaymentIntentCreateParamsPaymentDetailsMoneyServicesBeneficiaryDetailsDateOfBirth"
    ]
    """
    Date of birth.
    """
...
class PaymentIntentCreateParamsPaymentDetailsMoneyServicesBeneficiaryDetailsAddress(
    TypedDict,
):
    city: NotRequired[str]
    """
...
class PaymentIntentCreateParamsPaymentDetailsMoneyServicesBeneficiaryDetailsDateOfBirth(
    TypedDict,
):
    day: int
    """
...
class PaymentIntentCreateParamsPaymentMethodData(TypedDict):
    ...
    """
    sequra: NotRequired["PaymentIntentCreateParamsPaymentMethodDataSequra"]
    """
    ...
    """
    tamara: NotRequired["PaymentIntentCreateParamsPaymentMethodDataTamara"]
    """
    ...
    """
    vipps: NotRequired["PaymentIntentCreateParamsPaymentMethodDataVipps"]
    """
...
class PaymentIntentCreateParamsPaymentMethodDataSequra(TypedDict):
    pass
...
class PaymentIntentCreateParamsPaymentMethodDataTamara(TypedDict):
    pass
...
class PaymentIntentCreateParamsPaymentMethodDataVipps(TypedDict):
    pass
...
class PaymentIntentCreateParamsPaymentMethodOptions(TypedDict):
    ...
    """
    sequra: NotRequired[
        "Literal['']|PaymentIntentCreateParamsPaymentMethodOptionsSequra"
    ]
    """
    ...
    """
    sunbit: NotRequired[
        "Literal['']|PaymentIntentCreateParamsPaymentMethodOptionsSunbit"
    ]
    """
    ...
    """
    vipps: NotRequired[
        "Literal['']|PaymentIntentCreateParamsPaymentMethodOptionsVipps"
    ]
    """
...
class PaymentIntentCreateParamsPaymentMethodOptionsBillieCompanyDetails(
    TypedDict,
):
...
class PaymentIntentCreateParamsPaymentMethodOptionsBillieCompanyDetailsRegisteredAddress(
    TypedDict,
):
    city: NotRequired[str]
    """
...
class PaymentIntentCreateParamsPaymentMethodOptionsBlikMandateOptions(
    TypedDict,
):
...
class PaymentIntentCreateParamsPaymentMethodOptionsCardCaptureDelay(TypedDict):
...
class PaymentIntentCreateParamsPaymentMethodOptionsCardPresentAadeData(
    TypedDict,
):
...
class PaymentIntentCreateParamsPaymentMethodOptionsCardPresentCaptureDelay(
    TypedDict,
):
    days: NotRequired[int]
    hours: NotRequired[int]
...
class PaymentIntentCreateParamsPaymentMethodOptionsCrypto(TypedDict):
    ...
    transaction_verification_options: NotRequired[
        "PaymentIntentCreateParamsPaymentMethodOptionsCryptoTransactionVerificationOptions"
    ]
    """
...
class PaymentIntentCreateParamsPaymentMethodOptionsCryptoAmountReconciliation(
    TypedDict,
):
...
class PaymentIntentCreateParamsPaymentMethodOptionsCryptoTransactionVerificationOptions(
    TypedDict,
):
    network: Union[
...
class PaymentIntentCreateParamsPaymentMethodOptionsSequra(TypedDict):
    capture_method: NotRequired["Literal['']|Literal['manual']"]
    """
    Controls when the funds are captured from the customer's account.
...
class PaymentIntentCreateParamsPaymentMethodOptionsStripeBalanceMandateOptions(
    TypedDict,
):
...
class PaymentIntentCreateParamsPaymentMethodOptionsSunbit(TypedDict):
    capture_method: NotRequired["Literal['']|Literal['manual']"]
    """
    Controls when the funds are captured from the customer's account.
...
class PaymentIntentCreateParamsPaymentMethodOptionsVipps(TypedDict):
    capture_method: NotRequired["Literal['']|Literal['manual']"]
    """
    Controls when the funds are captured from the customer's account.
...
class PaymentIntentCreateParamsPaymentMethodOptionsVippsPaymentDetails(
    TypedDict,
):
    money_services: NotRequired[
...
class PaymentIntentCreateParamsPaymentMethodOptionsVippsPaymentDetailsMoneyServices(
    TypedDict,
):
    account_funding: NotRequired[
...
class PaymentIntentCreateParamsPaymentMethodOptionsVippsPaymentDetailsMoneyServicesAccountFunding(
    TypedDict,
):
    digital_asset_category: NotRequired[
        "Literal['blockchain_native', 'nft', 'other_non_fiat', 'stablecoin']|str"
