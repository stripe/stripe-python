...
class ProductCreateParams(RequestOptions):
    ...
    """
    identifiers: NotRequired["ProductCreateParamsIdentifiers"]
    """
...
class ProductCreateParamsDefaultPriceData(TypedDict):
    ...
    currency_options: NotRequired[
        "Dict[str, ProductCreateParamsDefaultPriceDataCurrencyOptions]|UntypedStripeObject[ProductCreateParamsDefaultPriceDataCurrencyOptions]"
    ]
    """
...
class ProductCreateParamsIdentifiers(TypedDict):
    ean: NotRequired[str]
    """
