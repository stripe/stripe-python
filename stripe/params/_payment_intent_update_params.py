...
class PaymentIntentUpdateParamsAmountDetails(TypedDict):
    ...
    surcharge: NotRequired[
        "Literal['']|PaymentIntentUpdateParamsAmountDetailsSurcharge"
    ]
    """
    ...
    """
    tip: NotRequired["Literal['']|PaymentIntentUpdateParamsAmountDetailsTip"]
    """
...
class PaymentIntentUpdateParamsAmountDetailsLineItemPaymentMethodOptionsCardEvCharging(
    TypedDict,
):
...
class PaymentIntentUpdateParamsAmountDetailsSurcharge(TypedDict):
    amount: NotRequired["Literal['']|int"]
    """
...
class PaymentIntentUpdateParamsAmountDetailsTip(TypedDict):
    amount: NotRequired["Literal['']|int"]
    """
...
class PaymentIntentUpdateParamsPaymentDetails(TypedDict):
    ...
    """
    fleet_data: NotRequired[
        "Literal['']|List[PaymentIntentUpdateParamsPaymentDetailsFleetDatum]"
    ]
    """
    ...
    money_services: NotRequired[
        "Literal['']|PaymentIntentUpdateParamsPaymentDetailsMoneyServices"
    ]
    """
...
class PaymentIntentUpdateParamsPaymentDetailsFleetDatum(TypedDict):
    ...
    """
    vat: NotRequired["PaymentIntentUpdateParamsPaymentDetailsFleetDatumVat"]
    """
    VAT and Invoice on Behalf (IOB) details.
    """


class PaymentIntentUpdateParamsPaymentDetailsFleetDatumPrimaryFuelFields(
    TypedDict,
):
    brand: NotRequired[
...
class PaymentIntentUpdateParamsPaymentDetailsFleetDatumStation(TypedDict):
...
class PaymentIntentUpdateParamsPaymentDetailsFleetDatumVat(TypedDict):
    iob_indicator: Union[
        Literal[
            "issuer_to_iob",
...
class PaymentIntentUpdateParamsPaymentDetailsMoneyServices(TypedDict):
...
class PaymentIntentUpdateParamsPaymentDetailsMoneyServicesAccountFundingSenderDetails(
    TypedDict,
):
    address: NotRequired[
...
class PaymentIntentUpdateParamsPaymentMethodData(TypedDict):
    ...
    """
    bizum: NotRequired["PaymentIntentUpdateParamsPaymentMethodDataBizum"]
    """
    ...
    """
    scalapay: NotRequired["PaymentIntentUpdateParamsPaymentMethodDataScalapay"]
    """
    ...
    """
    sequra: NotRequired["PaymentIntentUpdateParamsPaymentMethodDataSequra"]
    """
    ...
    """
    vipps: NotRequired["PaymentIntentUpdateParamsPaymentMethodDataVipps"]
    """
...
class PaymentIntentUpdateParamsPaymentMethodDataBizum(TypedDict):
    pass
...
class PaymentIntentUpdateParamsPaymentMethodDataScalapay(TypedDict):
    pass
...
class PaymentIntentUpdateParamsPaymentMethodDataSequra(TypedDict):
    pass
...
class PaymentIntentUpdateParamsPaymentMethodDataSunbit(TypedDict):
    pass
...
class PaymentIntentUpdateParamsPaymentMethodDataVipps(TypedDict):
    pass
...
class PaymentIntentUpdateParamsPaymentMethodOptions(TypedDict):
    ...
    """
    bizum: NotRequired[
        "Literal['']|PaymentIntentUpdateParamsPaymentMethodOptionsBizum"
    ]
    """
    ...
    scalapay: NotRequired[
        "Literal['']|PaymentIntentUpdateParamsPaymentMethodOptionsScalapay"
    ]
    """
    ...
    """
    sequra: NotRequired[
        "Literal['']|PaymentIntentUpdateParamsPaymentMethodOptionsSequra"
    ]
    """
    ...
    """
    vipps: NotRequired[
        "Literal['']|PaymentIntentUpdateParamsPaymentMethodOptionsVipps"
    ]
    """
...
class PaymentIntentUpdateParamsPaymentMethodOptionsBlikMandateOptions(
    TypedDict,
):
...
class PaymentIntentUpdateParamsPaymentMethodOptionsCardCaptureDelay(TypedDict):
...
class PaymentIntentUpdateParamsPaymentMethodOptionsCardPaymentDetailsMoneyServices(
    TypedDict,
):
    account_funding: NotRequired[
...
class PaymentIntentUpdateParamsPaymentMethodOptionsCardPresentCaptureDelay(
    TypedDict,
):
    days: NotRequired[int]
    hours: NotRequired[int]
...
class PaymentIntentUpdateParamsPaymentMethodOptionsCardPresentPaymentDetailsMoneyServices(
    TypedDict,
):
    account_funding: NotRequired[
...
class PaymentIntentUpdateParamsPaymentMethodOptionsCryptoAmountReconciliation(
    TypedDict,
):
...
class PaymentIntentUpdateParamsPaymentMethodOptionsGiftCard(TypedDict):
...
class PaymentIntentUpdateParamsPaymentMethodOptionsStripeBalanceMandateOptions(
    TypedDict,
):
...
class PaymentIntentUpdateParamsPaymentMethodOptionsVipps(TypedDict):
    capture_method: NotRequired["Literal['']|Literal['manual']"]
    """
    Controls when the funds are captured from the customer's account.
...
class PaymentIntentUpdateParamsPaymentMethodOptionsVippsPaymentDetails(
    TypedDict,
):
    money_services: NotRequired[
...
class PaymentIntentUpdateParamsPaymentMethodOptionsVippsPaymentDetailsMoneyServices(
    TypedDict,
):
    account_funding: NotRequired[
...
class PaymentIntentUpdateParamsPaymentMethodOptionsVippsPaymentDetailsMoneyServicesAccountFunding(
    TypedDict,
):
    digital_asset_category: NotRequired[
        "Literal['blockchain_native', 'nft', 'other_non_fiat', 'stablecoin']|str"
...
class PaymentIntentUpdateParamsTransferDataPaymentData(TypedDict):
    description: NotRequired[str]
    """
