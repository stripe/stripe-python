...
class AccountLinkCreateParamsUseCase(TypedDict):
    ...
    """
    recipient_onboarding: NotRequired[
...
class AccountLinkCreateParamsUseCaseRecipientOnboarding(TypedDict):
    collection_options: NotRequired[
...
class AccountLinkCreateParamsUseCaseRecipientOnboardingCollectionOptions(
    TypedDict,
):
    fields: NotRequired[Literal["currently_due", "eventually_due"]]
    """
...
class AccountLinkCreateParamsUseCaseRecipientUpdate(TypedDict):
    collection_options: NotRequired[
...
class AccountLinkCreateParamsUseCaseRecipientUpdateCollectionOptions(
    TypedDict
):
    fields: NotRequired[Literal["currently_due", "eventually_due"]]
    """
