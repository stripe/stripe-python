...
class ManualRuleCreateParams(TypedDict):
    location: NotRequired["ManualRuleCreateParamsLocation"]
    """
    Location where the rule applies.
    """
    products: NotRequired[List["ManualRuleCreateParamsProduct"]]
    """
    Products associated with the rule.
    """
    scheduled_tax_rates: List["ManualRuleCreateParamsScheduledTaxRate"]
    """
    Tax rates to be applied.
    """


class ManualRuleCreateParamsLocation(TypedDict):
    country: str
    """
    Country ISO-3166.
    """
...
class ManualRuleCreateParamsProduct(TypedDict):
...
class ManualRuleCreateParamsScheduledTaxRate(TypedDict):
    rates: List["ManualRuleCreateParamsScheduledTaxRateRate"]
    """
...
class ManualRuleCreateParamsScheduledTaxRateRate(TypedDict):
