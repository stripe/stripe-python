...
_import_map = {
    ...
    "AlertCreateParamsCreditBalanceThresholdFilter": (
        "stripe.params.billing._alert_create_params",
        False,
    ),
    ...
    "AlertCreateParamsCreditBalanceThresholdFilterCreditGrantsApplicabilityConfig": (
        "stripe.params.billing._alert_create_params",
        False,
    ),
    "AlertCreateParamsCreditBalanceThresholdFilterCreditGrantsApplicabilityConfigScope": (
        "stripe.params.billing._alert_create_params",
        False,
    ),
    ...
    "AlertCreateParamsCreditBalanceThresholdLte": (
        "stripe.params.billing._alert_create_params",
        False,
    ),
