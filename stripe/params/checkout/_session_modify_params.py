...
class SessionModifyParamsPaymentIntentData(TypedDict):
...
class SessionModifyParamsShippingOptionShippingRateDataFixedAmount(TypedDict):
    ...
    currency_options: NotRequired[
        "Dict[str, SessionModifyParamsShippingOptionShippingRateDataFixedAmountCurrencyOptions]|UntypedStripeObject[SessionModifyParamsShippingOptionShippingRateDataFixedAmountCurrencyOptions]"
    ]
    """
