...
class SessionModifyParamsShippingOptionShippingRateDataFixedAmount(TypedDict):
    ...
    currency_options: NotRequired[
        "Dict[str, SessionModifyParamsShippingOptionShippingRateDataFixedAmountCurrencyOptions]|DictLikeObject[SessionModifyParamsShippingOptionShippingRateDataFixedAmountCurrencyOptions]"
    ]
    """
