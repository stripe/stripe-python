...
class SessionUpdateParamsDiscountCouponData(TypedDict):
    ...
    """
    duration: NotRequired["Literal['forever', 'once', 'repeating']|str"]
    """
...
class SessionUpdateParamsLineItemAdjustableQuantity(TypedDict):
    enabled: bool
    """
...
class SessionUpdateParamsLineItemPriceData(TypedDict):
    currency: str
    """
    ...
    """
    recurring: NotRequired["SessionUpdateParamsLineItemPriceDataRecurring"]
    """
...
class SessionUpdateParamsLineItemPriceDataProductData(TypedDict):
...
class SessionUpdateParamsShippingOptionShippingRateDataFixedAmount(TypedDict):
    ...
    currency_options: NotRequired[
        "Dict[str, SessionUpdateParamsShippingOptionShippingRateDataFixedAmountCurrencyOptions]|UntypedStripeObject[SessionUpdateParamsShippingOptionShippingRateDataFixedAmountCurrencyOptions]"
    ]
    """
