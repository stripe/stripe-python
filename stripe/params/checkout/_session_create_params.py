...
class SessionCreateParamsShippingOptionShippingRateDataFixedAmount(TypedDict):
    ...
    currency_options: NotRequired[
        "Dict[str, SessionCreateParamsShippingOptionShippingRateDataFixedAmountCurrencyOptions]|DictLikeObject[SessionCreateParamsShippingOptionShippingRateDataFixedAmountCurrencyOptions]"
    ]
    """
