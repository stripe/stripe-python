...
class InvoiceUpdateParamsPaymentSettingsPaymentMethodOptions(TypedDict):
    ...
    bacs_debit: NotRequired[
        "Literal['']|InvoiceUpdateParamsPaymentSettingsPaymentMethodOptionsBacsDebit"
    ]
    """
    ...
    """
    bizum: NotRequired[
        "Literal['']|InvoiceUpdateParamsPaymentSettingsPaymentMethodOptionsBizum"
    ]
    """
    ...
    check_scan: NotRequired[
        "Literal['']|InvoiceUpdateParamsPaymentSettingsPaymentMethodOptionsCheckScan"
    ]
    """
    ...
    wechat_pay: NotRequired[
        "Literal['']|InvoiceUpdateParamsPaymentSettingsPaymentMethodOptionsWechatPay"
    ]
    """
...
class InvoiceUpdateParamsPaymentSettingsPaymentMethodOptionsBacsDebit(
    TypedDict,
):
...
class InvoiceUpdateParamsPaymentSettingsPaymentMethodOptionsBizum(TypedDict):
    pass
...
class InvoiceUpdateParamsShippingCostShippingRateDataFixedAmount(TypedDict):
    ...
    currency_options: NotRequired[
        "Dict[str, InvoiceUpdateParamsShippingCostShippingRateDataFixedAmountCurrencyOptions]|UntypedStripeObject[InvoiceUpdateParamsShippingCostShippingRateDataFixedAmountCurrencyOptions]"
    ]
    """
