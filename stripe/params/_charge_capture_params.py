...
class ChargeCaptureParamsPaymentDetails(TypedDict):
    ...
    fleet_data: NotRequired[
        "Literal['']|List[ChargeCaptureParamsPaymentDetailsFleetDatum]"
    ]
    """
    ...
    money_services: NotRequired[
        "Literal['']|ChargeCaptureParamsPaymentDetailsMoneyServices"
    ]
    """
...
class ChargeCaptureParamsPaymentDetailsFleetDatum(TypedDict):
    ...
    """
    station: NotRequired["ChargeCaptureParamsPaymentDetailsFleetDatumStation"]
    """
    Station and acceptor location details.
    """
    vat: NotRequired["ChargeCaptureParamsPaymentDetailsFleetDatumVat"]
    """
    VAT and Invoice on Behalf (IOB) details.
    """


class ChargeCaptureParamsPaymentDetailsFleetDatumPrimaryFuelFields(TypedDict):
    brand: NotRequired[
        Literal[
            "aafes",
            "amerada_hess",
...
class ChargeCaptureParamsPaymentDetailsFleetDatumStation(TypedDict):
...
class ChargeCaptureParamsPaymentDetailsFleetDatumStationServiceLocation(
    TypedDict,
):
    city: NotRequired[str]
    """
...
class ChargeCaptureParamsPaymentDetailsFleetDatumVat(TypedDict):
...
class ChargeCaptureParamsPaymentDetailsMoneyServices(TypedDict):
    account_funding: NotRequired[
        "Literal['']|ChargeCaptureParamsPaymentDetailsMoneyServicesAccountFunding"
    ]
    """
...
class ChargeCaptureParamsPaymentDetailsMoneyServicesAccountFunding(TypedDict):
    beneficiary_account: NotRequired[str]
    """
    ID of the Account representing the beneficiary in this account funding transaction.
    """
    beneficiary_details: NotRequired[
        "Literal['']|ChargeCaptureParamsPaymentDetailsMoneyServicesAccountFundingBeneficiaryDetails"
    ]
    """
    ...
    sender_details: NotRequired[
        "Literal['']|ChargeCaptureParamsPaymentDetailsMoneyServicesAccountFundingSenderDetails"
    ]
    """
...
class ChargeCaptureParamsPaymentDetailsMoneyServicesAccountFundingBeneficiaryDetails(
    TypedDict,
):
    address: NotRequired[
...
class ChargeCaptureParamsPaymentDetailsMoneyServicesAccountFundingBeneficiaryDetailsAddress(
    TypedDict,
):
    city: NotRequired[str]
    """
...
class ChargeCaptureParamsPaymentDetailsMoneyServicesAccountFundingBeneficiaryDetailsDateOfBirth(
    TypedDict,
):
    day: int
    """
...
class ChargeCaptureParamsPaymentDetailsMoneyServicesAccountFundingSenderDetails(
    TypedDict,
):
    address: NotRequired[
...
class ChargeCaptureParamsPaymentDetailsMoneyServicesAccountFundingSenderDetailsAddress(
    TypedDict,
):
    city: NotRequired[str]
    """
...
class ChargeCaptureParamsPaymentDetailsMoneyServicesAccountFundingSenderDetailsDateOfBirth(
    TypedDict,
):
    day: int
    """
