...
class SetupIntentConfirmParamsPaymentMethodData(TypedDict):
    ...
    """
    sunbit: NotRequired["SetupIntentConfirmParamsPaymentMethodDataSunbit"]
    """
    ...
    """
    tamara: NotRequired["SetupIntentConfirmParamsPaymentMethodDataTamara"]
    """
    ...
    """
    vipps: NotRequired["SetupIntentConfirmParamsPaymentMethodDataVipps"]
    """
...
class SetupIntentConfirmParamsPaymentMethodDataSunbit(TypedDict):
    pass
...
class SetupIntentConfirmParamsPaymentMethodDataTamara(TypedDict):
    pass
...
class SetupIntentConfirmParamsPaymentMethodDataVipps(TypedDict):
    pass
...
class SetupIntentConfirmParamsPaymentMethodOptionsStripeBalance(TypedDict):
    mandate_options: NotRequired[
        "SetupIntentConfirmParamsPaymentMethodOptionsStripeBalanceMandateOptions"
    ]
    """
    Additional fields for mandate creation.
    """
...
class SetupIntentConfirmParamsPaymentMethodOptionsStripeBalanceMandateOptions(
    TypedDict,
):
...
class SetupIntentConfirmParamsSetupDetailsBenefit(TypedDict):
    fr_meal_voucher: NotRequired[
        "Literal['']|SetupIntentConfirmParamsSetupDetailsBenefitFrMealVoucher"
    ]
    """
