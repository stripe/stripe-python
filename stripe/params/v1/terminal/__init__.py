...
from stripe.params.v1.terminal._configuration_create_params import (
    ConfigurationCreateParams as ConfigurationCreateParams,
)
from stripe.params.v1.terminal._configuration_delete_params import (
    ConfigurationDeleteParams as ConfigurationDeleteParams,
)
from stripe.params.v1.terminal._configuration_list_params import (
    ConfigurationListParams as ConfigurationListParams,
)
from stripe.params.v1.terminal._configuration_modify_params import (
    ConfigurationModifyParams as ConfigurationModifyParams,
)
from stripe.params.v1.terminal._configuration_retrieve_params import (
    ConfigurationRetrieveParams as ConfigurationRetrieveParams,
)
from stripe.params.v1.terminal._configuration_update_params import (
    ConfigurationUpdateParams as ConfigurationUpdateParams,
)
from stripe.params.v1.terminal._connection_token_create_params import (
...
from stripe.params.v1.terminal._reader_cancel_action_params import (
    ReaderCancelActionParams as ReaderCancelActionParams,
)
from stripe.params.v1.terminal._reader_collect_inputs_params import (
    ReaderCollectInputsParams as ReaderCollectInputsParams,
)
from stripe.params.v1.terminal._reader_collect_payment_method_params import (
    ReaderCollectPaymentMethodParams as ReaderCollectPaymentMethodParams,
)
from stripe.params.v1.terminal._reader_confirm_payment_intent_params import (
    ReaderConfirmPaymentIntentParams as ReaderConfirmPaymentIntentParams,
)
from stripe.params.v1.terminal._reader_create_params import (
    ReaderCreateParams as ReaderCreateParams,
)
from stripe.params.v1.terminal._reader_delete_params import (
    ReaderDeleteParams as ReaderDeleteParams,
)
from stripe.params.v1.terminal._reader_list_params import (
    ReaderListParams as ReaderListParams,
)
from stripe.params.v1.terminal._reader_modify_params import (
    ReaderModifyParams as ReaderModifyParams,
)
from stripe.params.v1.terminal._reader_present_payment_method_params import (
    ReaderPresentPaymentMethodParams as ReaderPresentPaymentMethodParams,
)
from stripe.params.v1.terminal._reader_process_payment_intent_params import (
    ReaderProcessPaymentIntentParams as ReaderProcessPaymentIntentParams,
)
from stripe.params.v1.terminal._reader_process_setup_intent_params import (
    ReaderProcessSetupIntentParams as ReaderProcessSetupIntentParams,
)
from stripe.params.v1.terminal._reader_refund_payment_params import (
    ReaderRefundPaymentParams as ReaderRefundPaymentParams,
)
from stripe.params.v1.terminal._reader_retrieve_params import (
    ReaderRetrieveParams as ReaderRetrieveParams,
)
from stripe.params.v1.terminal._reader_set_reader_display_params import (
    ReaderSetReaderDisplayParams as ReaderSetReaderDisplayParams,
)
from stripe.params.v1.terminal._reader_succeed_input_collection_params import (
    ReaderSucceedInputCollectionParams as ReaderSucceedInputCollectionParams,
)
from stripe.params.v1.terminal._reader_timeout_input_collection_params import (
    ReaderTimeoutInputCollectionParams as ReaderTimeoutInputCollectionParams,
)
from stripe.params.v1.terminal._reader_update_params import (
