...
class SetupIntentUpdateParamsPaymentMethodData(TypedDict):
    ...
    """
    gift_card: NotRequired["SetupIntentUpdateParamsPaymentMethodDataGiftCard"]
    """
    ...
    """
    sequra: NotRequired["SetupIntentUpdateParamsPaymentMethodDataSequra"]
    """
    ...
    """
    tamara: NotRequired["SetupIntentUpdateParamsPaymentMethodDataTamara"]
    """
    ...
    """
    vipps: NotRequired["SetupIntentUpdateParamsPaymentMethodDataVipps"]
    """
...
class SetupIntentUpdateParamsPaymentMethodDataGiftCard(TypedDict):
    gift_card: str
    """
...
class SetupIntentUpdateParamsPaymentMethodDataSequra(TypedDict):
    pass
...
class SetupIntentUpdateParamsPaymentMethodDataSunbit(TypedDict):
    pass
...
class SetupIntentUpdateParamsPaymentMethodDataTamara(TypedDict):
    pass
...
class SetupIntentUpdateParamsPaymentMethodDataVipps(TypedDict):
    pass
...
class SetupIntentUpdateParamsPaymentMethodOptionsBlik(TypedDict):
...
class SetupIntentUpdateParamsPaymentMethodOptionsBlikMandateOptions(TypedDict):
...
class SetupIntentUpdateParamsPaymentMethodOptionsStripeBalance(TypedDict):
    mandate_options: NotRequired[
        "SetupIntentUpdateParamsPaymentMethodOptionsStripeBalanceMandateOptions"
    ]
    """
    Additional fields for mandate creation.
    """
...
class SetupIntentUpdateParamsPaymentMethodOptionsStripeBalanceMandateOptions(
    TypedDict,
):
