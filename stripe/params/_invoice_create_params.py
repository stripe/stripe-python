...
class InvoiceCreateParams(RequestOptions):
    ...
    """
    managed_payments: NotRequired["InvoiceCreateParamsManagedPayments"]
    """
...
class InvoiceCreateParamsManagedPayments(TypedDict):
...
class InvoiceCreateParamsPaymentSettingsPaymentMethodOptions(TypedDict):
    ...
    """
    blik: NotRequired[
        "Literal['']|InvoiceCreateParamsPaymentSettingsPaymentMethodOptionsBlik"
    ]
    """
    ...
    wechat_pay: NotRequired[
        "Literal['']|InvoiceCreateParamsPaymentSettingsPaymentMethodOptionsWechatPay"
    ]
    """
...
class InvoiceCreateParamsPaymentSettingsPaymentMethodOptionsWechatPay(
    TypedDict,
):
...
class InvoiceCreateParamsShippingCostShippingRateDataFixedAmount(TypedDict):
    ...
    currency_options: NotRequired[
        "Dict[str, InvoiceCreateParamsShippingCostShippingRateDataFixedAmountCurrencyOptions]|UntypedStripeObject[InvoiceCreateParamsShippingCostShippingRateDataFixedAmountCurrencyOptions]"
    ]
    """
