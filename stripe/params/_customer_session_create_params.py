...
class CustomerSessionCreateParamsComponentsMobilePaymentElementFeatures(
    ...
    If not specified, defaults to ["always"]. In order to display all saved payment methods, specify ["always", "limited", "unspecified"].
    """
    payment_method_redisplay: NotRequired["Literal['disabled', 'enabled']|str"]
    """
...
class CustomerSessionCreateParamsComponentsPaymentElementFeatures(TypedDict):
    ...
    payment_method_save_usage: NotRequired[
        "Literal['off_session', 'on_session']|str"
    ]
    """
...
class CustomerSessionCreateParamsComponentsTaxIdElementFeatures(TypedDict):
    tax_id_redisplay: NotRequired["Literal['disabled', 'enabled']|str"]
    """
    ...
    """
    tax_id_save: NotRequired["Literal['disabled', 'enabled']|str"]
    """
