...
class SetupIntentCreateParams(RequestOptions):
    ...
    """
    usage: NotRequired["Literal['off_session', 'on_session']|str"]
    """
...
class SetupIntentCreateParamsPaymentMethodData(TypedDict):
    ...
    """
    vipps: NotRequired["SetupIntentCreateParamsPaymentMethodDataVipps"]
    """
...
class SetupIntentCreateParamsPaymentMethodDataVipps(TypedDict):
    pass
...
class SetupIntentCreateParamsSetupDetailsBenefit(TypedDict):
    fr_meal_voucher: NotRequired[
        "Literal['']|SetupIntentCreateParamsSetupDetailsBenefitFrMealVoucher"
    ]
    """
