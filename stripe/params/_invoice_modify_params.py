...
class InvoiceModifyParamsShippingCostShippingRateDataFixedAmount(TypedDict):
    ...
    currency_options: NotRequired[
        "Dict[str, InvoiceModifyParamsShippingCostShippingRateDataFixedAmountCurrencyOptions]|DictLikeObject[InvoiceModifyParamsShippingCostShippingRateDataFixedAmountCurrencyOptions]"
    ]
    """
