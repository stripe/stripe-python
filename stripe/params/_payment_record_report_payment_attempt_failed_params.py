...
class PaymentRecordReportPaymentAttemptFailedParamsProcessorDetails(TypedDict):
    custom: NotRequired[
...
class PaymentRecordReportPaymentAttemptFailedParamsProcessorDetailsCustom(
    TypedDict,
):
