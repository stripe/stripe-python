...
class PaymentMethodConfigurationModifyParams(RequestOptions):
    ...
    """
    vipps: NotRequired["PaymentMethodConfigurationModifyParamsVipps"]
    """
...
class PaymentMethodConfigurationModifyParamsVipps(TypedDict):
    display_preference: NotRequired[
...
class PaymentMethodConfigurationModifyParamsVippsDisplayPreference(TypedDict):
    preference: NotRequired["Literal['none', 'off', 'on']|str"]
    """
    The account's preference for whether or not to display this payment method.
    """
