...
class PaymentIntentConfirmParamsAmountDetails(TypedDict):
    ...
    surcharge: NotRequired[
        "Literal['']|PaymentIntentConfirmParamsAmountDetailsSurcharge"
    ]
    """
    ...
    """
    tip: NotRequired["Literal['']|PaymentIntentConfirmParamsAmountDetailsTip"]
    """
...
class PaymentIntentConfirmParamsAmountDetailsLineItemPaymentMethodOptionsCardEvCharging(
    TypedDict,
):
...
class PaymentIntentConfirmParamsAmountDetailsLineItemPaymentMethodOptionsCardFleetData(
    TypedDict,
):
    product_type: Union[
        Literal[
...
class PaymentIntentConfirmParamsAmountDetailsSurcharge(TypedDict):
    amount: NotRequired["Literal['']|int"]
    """
...
class PaymentIntentConfirmParamsAmountDetailsTip(TypedDict):
    amount: NotRequired["Literal['']|int"]
    """
...
class PaymentIntentConfirmParamsPaymentDetails(TypedDict):
    ...
    """
    fleet_data: NotRequired[
        "Literal['']|List[PaymentIntentConfirmParamsPaymentDetailsFleetDatum]"
    ]
    """
    ...
    money_services: NotRequired[
        "Literal['']|PaymentIntentConfirmParamsPaymentDetailsMoneyServices"
    ]
    """
...
class PaymentIntentConfirmParamsPaymentDetailsFleetDatum(TypedDict):
    ...
    """
    vat: NotRequired["PaymentIntentConfirmParamsPaymentDetailsFleetDatumVat"]
    """
    VAT and Invoice on Behalf (IOB) details.
    """


class PaymentIntentConfirmParamsPaymentDetailsFleetDatumPrimaryFuelFields(
    TypedDict,
):
    brand: NotRequired[
...
class PaymentIntentConfirmParamsPaymentDetailsFleetDatumStation(TypedDict):
...
class PaymentIntentConfirmParamsPaymentDetailsFleetDatumVat(TypedDict):
    iob_indicator: Union[
        Literal[
            "issuer_to_iob",
...
class PaymentIntentConfirmParamsPaymentDetailsMoneyServices(TypedDict):
    account_funding: NotRequired[
        "Literal['']|PaymentIntentConfirmParamsPaymentDetailsMoneyServicesAccountFunding"
    ]
    """
    Account funding transaction details including sender information.
    """
    beneficiary_details: NotRequired[
        "Literal['']|PaymentIntentConfirmParamsPaymentDetailsMoneyServicesBeneficiaryDetails"
    ]
    """
...
class PaymentIntentConfirmParamsPaymentDetailsMoneyServicesBeneficiaryDetails(
    TypedDict,
):
...
class PaymentIntentConfirmParamsPaymentDetailsMoneyServicesBeneficiaryDetailsDateOfBirth(
    TypedDict,
):
    day: int
    """
...
class PaymentIntentConfirmParamsPaymentMethodData(TypedDict):
    ...
    """
    tamara: NotRequired["PaymentIntentConfirmParamsPaymentMethodDataTamara"]
    """
    ...
    """
    vipps: NotRequired["PaymentIntentConfirmParamsPaymentMethodDataVipps"]
    """
...
class PaymentIntentConfirmParamsPaymentMethodDataTamara(TypedDict):
    pass
...
class PaymentIntentConfirmParamsPaymentMethodDataVipps(TypedDict):
    pass
...
class PaymentIntentConfirmParamsPaymentMethodOptions(TypedDict):
    ...
    """
    sunbit: NotRequired[
        "Literal['']|PaymentIntentConfirmParamsPaymentMethodOptionsSunbit"
    ]
    """
    ...
    """
    vipps: NotRequired[
        "Literal['']|PaymentIntentConfirmParamsPaymentMethodOptionsVipps"
    ]
    """
...
class PaymentIntentConfirmParamsPaymentMethodOptionsBillie(TypedDict):
    ...
    company_details: NotRequired[
        "Literal['']|PaymentIntentConfirmParamsPaymentMethodOptionsBillieCompanyDetails"
    ]
    """
...
class PaymentIntentConfirmParamsPaymentMethodOptionsBillieCompanyDetails(
    TypedDict,
):
...
class PaymentIntentConfirmParamsPaymentMethodOptionsBillieCompanyDetailsRegisteredAddress(
    TypedDict,
):
    city: NotRequired[str]
    """
...
class PaymentIntentConfirmParamsPaymentMethodOptionsCardPaymentDetails(
    TypedDict,
):
    money_services: NotRequired[
...
class PaymentIntentConfirmParamsPaymentMethodOptionsCardPaymentDetailsMoneyServices(
    TypedDict,
):
    account_funding: NotRequired[
...
class PaymentIntentConfirmParamsPaymentMethodOptionsCardPresentAadeData(
    TypedDict,
):
...
class PaymentIntentConfirmParamsPaymentMethodOptionsCardPresentPaymentDetailsMoneyServices(
    TypedDict,
):
    account_funding: NotRequired[
...
class PaymentIntentConfirmParamsPaymentMethodOptionsCrypto(TypedDict):
    ...
    transaction_verification_options: NotRequired[
        "PaymentIntentConfirmParamsPaymentMethodOptionsCryptoTransactionVerificationOptions"
    ]
    """
...
class PaymentIntentConfirmParamsPaymentMethodOptionsCryptoAmountReconciliation(
    TypedDict,
):
...
class PaymentIntentConfirmParamsPaymentMethodOptionsStripeBalanceMandateOptions(
    TypedDict,
):
...
class PaymentIntentConfirmParamsPaymentMethodOptionsSunbit(TypedDict):
    capture_method: NotRequired["Literal['']|Literal['manual']"]
    """
    Controls when the funds are captured from the customer's account.
...
class PaymentIntentConfirmParamsPaymentMethodOptionsVipps(TypedDict):
    capture_method: NotRequired["Literal['']|Literal['manual']"]
    """
    Controls when the funds are captured from the customer's account.
...
class PaymentIntentConfirmParamsPaymentMethodOptionsVippsPaymentDetails(
    TypedDict,
):
    money_services: NotRequired[
...
class PaymentIntentConfirmParamsPaymentMethodOptionsVippsPaymentDetailsMoneyServices(
    TypedDict,
):
    account_funding: NotRequired[
...
class PaymentIntentConfirmParamsPaymentMethodOptionsVippsPaymentDetailsMoneyServicesAccountFunding(
    TypedDict,
):
    digital_asset_category: NotRequired[
        "Literal['blockchain_native', 'nft', 'other_non_fiat', 'stablecoin']|str"
