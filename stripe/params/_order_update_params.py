...
class OrderUpdateParamsLineItemProductData(TypedDict):
    ...
    """
    identifiers: NotRequired["OrderUpdateParamsLineItemProductDataIdentifiers"]
    """
...
class OrderUpdateParamsLineItemProductDataIdentifiers(TypedDict):
...
class OrderUpdateParamsShippingCostShippingRateDataFixedAmount(TypedDict):
    ...
    currency_options: NotRequired[
        "Dict[str, OrderUpdateParamsShippingCostShippingRateDataFixedAmountCurrencyOptions]|UntypedStripeObject[OrderUpdateParamsShippingCostShippingRateDataFixedAmountCurrencyOptions]"
    ]
    """
