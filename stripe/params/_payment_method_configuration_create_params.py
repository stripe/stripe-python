...
class PaymentMethodConfigurationCreateParams(RequestOptions):
    ...
    """
    bizum: NotRequired["PaymentMethodConfigurationCreateParamsBizum"]
    """
    ...
    """
    scalapay: NotRequired["PaymentMethodConfigurationCreateParamsScalapay"]
    """
    ...
    """
    sequra: NotRequired["PaymentMethodConfigurationCreateParamsSequra"]
    """
    ...
    """
    sunbit: NotRequired["PaymentMethodConfigurationCreateParamsSunbit"]
    """
    ...
    """
    vipps: NotRequired["PaymentMethodConfigurationCreateParamsVipps"]
    """
...
class PaymentMethodConfigurationCreateParamsBizum(TypedDict):
    display_preference: NotRequired[
...
class PaymentMethodConfigurationCreateParamsScalapay(TypedDict):
    display_preference: NotRequired[
...
class PaymentMethodConfigurationCreateParamsSequra(TypedDict):
    display_preference: NotRequired[
...
class PaymentMethodConfigurationCreateParamsSequraDisplayPreference(TypedDict):
    preference: NotRequired["Literal['none', 'off', 'on']|str"]
    """
    The account's preference for whether or not to display this payment method.
    """
...
class PaymentMethodConfigurationCreateParamsSunbit(TypedDict):
    display_preference: NotRequired[
...
class PaymentMethodConfigurationCreateParamsVipps(TypedDict):
    display_preference: NotRequired[
...
class PaymentMethodConfigurationCreateParamsVippsDisplayPreference(TypedDict):
    preference: NotRequired["Literal['none', 'off', 'on']|str"]
    """
    The account's preference for whether or not to display this payment method.
    """
