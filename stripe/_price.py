...
if TYPE_CHECKING:
    ...
    from stripe.param._price_create_params import PriceCreateParams
    from stripe.param._price_list_params import PriceListParams
    from stripe.param._price_modify_params import PriceModifyParams
    from stripe.param._price_retrieve_params import PriceRetrieveParams
    from stripe.param._price_search_params import PriceSearchParams
