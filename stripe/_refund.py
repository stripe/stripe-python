...
if TYPE_CHECKING:
    ...
    from stripe._refund_cancel_params import RefundCancelParams
    from stripe._refund_create_params import RefundCreateParams
    from stripe._refund_expire_params import RefundExpireParams
    from stripe._refund_list_params import RefundListParams
    from stripe._refund_modify_params import RefundModifyParams
    from stripe._refund_retrieve_params import RefundRetrieveParams
