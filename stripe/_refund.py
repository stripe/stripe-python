...
if TYPE_CHECKING:
    ...
    from stripe.params.v1._refund_cancel_params import RefundCancelParams
    from stripe.params.v1._refund_create_params import RefundCreateParams
    from stripe.params.v1._refund_expire_params import RefundExpireParams
    from stripe.params.v1._refund_list_params import RefundListParams
    from stripe.params.v1._refund_modify_params import RefundModifyParams
    from stripe.params.v1._refund_retrieve_params import RefundRetrieveParams
