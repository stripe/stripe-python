...
if TYPE_CHECKING:
    from stripe.params.v1.financial_connections._transaction_list_params import (
        TransactionListParams,
    )
    from stripe.params.v1.financial_connections._transaction_retrieve_params import (
