...
class Charge(
    ...
    class CaptureParams(RequestOptions):
        ...
        """
        payment_details: NotRequired["Charge.CaptureParamsPaymentDetails"]
        """
    ...
    class CaptureParamsPaymentDetails(TypedDict):
        ...
        """
        flight: NotRequired["Charge.CaptureParamsPaymentDetailsFlight"]
        """
    ...
    class CaptureParamsPaymentDetailsCarRental(TypedDict):
        affiliate: NotRequired[
            "Charge.CaptureParamsPaymentDetailsCarRentalAffiliate"
        ]
        """
        ...
        delivery: NotRequired[
            "Charge.CaptureParamsPaymentDetailsCarRentalDelivery"
        ]
        """
        ...
        pickup_address: NotRequired[
            "Charge.CaptureParamsPaymentDetailsCarRentalPickupAddress"
        ]
        """
        Car pick-up address.
        """
        ...
        return_address: NotRequired[
            "Charge.CaptureParamsPaymentDetailsCarRentalReturnAddress"
        ]
        """
        Car return address.
        """
    ...
    class ModifyParamsPaymentDetails(TypedDict):
        car_rental: NotRequired["Charge.ModifyParamsPaymentDetailsCarRental"]
        """
        Car rental details for this PaymentIntent.
        """
        event_details: NotRequired[
        ...
        Event details for this PaymentIntent
        """
        flight: NotRequired["Charge.ModifyParamsPaymentDetailsFlight"]
        """
        Flight reservation details for this PaymentIntent
        """
    ...
    class ModifyParamsPaymentDetailsCarRental(TypedDict):
        affiliate: NotRequired[
            "Charge.ModifyParamsPaymentDetailsCarRentalAffiliate"
        ]
        """
        Affiliate details for this purchase.
        """
        ...
        """
        delivery: NotRequired[
            "Charge.ModifyParamsPaymentDetailsCarRentalDelivery"
        ]
        """
        Delivery details for this purchase.
        """
        ...
        """
        pickup_address: NotRequired[
            "Charge.ModifyParamsPaymentDetailsCarRentalPickupAddress"
        ]
        """
        Car pick-up address.
        """
        ...
        """
        return_address: NotRequired[
            "Charge.ModifyParamsPaymentDetailsCarRentalReturnAddress"
        ]
        """
        Car return address.
        """
