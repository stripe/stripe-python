...
if TYPE_CHECKING:
    ...
    from stripe.params.v1._charge_capture_params import ChargeCaptureParams
    from stripe.params.v1._charge_create_params import ChargeCreateParams
    from stripe.params.v1._charge_list_params import ChargeListParams
    from stripe.params.v1._charge_list_refunds_params import (
        ChargeListRefundsParams,
    )
    from stripe.params.v1._charge_modify_params import ChargeModifyParams
    from stripe.params.v1._charge_retrieve_params import ChargeRetrieveParams
    from stripe.params.v1._charge_retrieve_refund_params import (
        ChargeRetrieveRefundParams,
    )
    from stripe.params.v1._charge_search_params import ChargeSearchParams
